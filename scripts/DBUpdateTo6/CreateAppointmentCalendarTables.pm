...
sub Run {
    ...
    # Check if the appointment calendar tables already exist, by testing if OTOBOAppointmentCalendar package is
    ...
    for my $Package (@RepositoryList) {
        ...
        # Package is not the OTOBOAppointmentCalendar package.
        next PACKAGE if $Package->{Name}->{Content} ne 'OTOBOAppointmentCalendar';
    ...
    if ($PackageVersion) {
        ...
        print "\n    Found package OTOBOAppointmentCalendar $PackageVersion" if $Verbose;
