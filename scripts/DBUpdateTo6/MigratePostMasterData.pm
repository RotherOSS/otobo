...
sub Run {
    ...
    PFTABLE:
    for my $Field (qw(X-OTOBO-ArticleType X-OTOBO-FollowUp-ArticleType)) {
        ...
        my $NewKeyValue;
        if ( $Field eq 'X-OTOBO-ArticleType' ) {
            $NewKeyValue = 'X-OTOBO-IsVisibleForCustomer';
        }
        else {
            $NewKeyValue = 'X-OTOBO-FollowUp-IsVisibleForCustomer';
        }
