...
package scripts::DBUpdateTo11_1::Base;
...
scripts::DBUpdateTo11_1::Base - base class for migrations.

=head1 SYNOPSIS

    # Used in task modules in the directory scripts/DBUpdateTo11_1
    use parent qw(scripts::DBUpdateTo11_1::Base);

=head1 DESCRIPTION

This modules provides methods for the task modules that are located in F<scripts/DBUpdateTo11_1>.
