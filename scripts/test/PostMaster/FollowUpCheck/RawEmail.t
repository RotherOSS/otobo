...
my @Tests = (
    ...
    {
        Name            => 'ticket number is base64 transfer encoded',
        ExpectedRetCode => 1,                                            # no follow up
        Email           => <<"END_EML",
...
Subject: Sample of multipart/mixed with only a CSV attachment
...
END_EML
    ...
    # FollowUp is detected because the ticket number is not encoded
    {
        Name            => 'ticket number is 7bit transfer encoded',
