...
my @Tests = (
    {
        Name           => 'Test supported tag - <OTOBO_CONFIG_ScriptAlias>',
    ...
    },
    {
        ...
        TemplateText   => 'Test: <OTOBO_AGENT_SUBJECT> <OTOBO_AGENT_BODY> <OTOBO_CUSTOMER_BODY> <OTOBO_CUSTOMER_SUBJECT>',
        ExpectedResult => 'Test: - - - -',
    },
    {
        Name => 'Test unsupported tags with [n]',
        TemplateText =>
            'Test: <OTOBO_AGENT_SUBJECT[2]> <OTOBO_AGENT_BODY[2]> <OTOBO_CUSTOMER_BODY[2]> <OTOBO_CUSTOMER_SUBJECT[2]>',
        ExpectedResult => 'Test: - - - -',
        TicketID       => $TicketID,
        Data           => \%Data,
    },
