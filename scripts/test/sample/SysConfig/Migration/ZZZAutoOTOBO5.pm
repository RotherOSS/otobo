...
# VERSION:1.1
package scripts::test::sample::SysConfig::Migration::ZZZAutoOTOBO5;
use strict;
use warnings;
no warnings 'redefine';
use utf8;

## nofilter(TidyAll::Plugin::OTOBO::Perl::PerlTidy)
...
$Self->{'Frontend::NotifyModule'}->{'100-OTOBOBusiness'} =  {
  'Group' => 'admin',
  'Module' => 'Kernel::Output::HTML::Notification::AgentOTOBOBusiness'
};
