...
INSERT INTO salutation (id, name, text, content_type, comments, valid_id, create_by, create_time, change_by, change_time)
    VALUES
    (1, 'system standard salutation (en)', 'Dear <OTOBO_CUSTOMER_REALNAME>,
...
INSERT INTO system_address (id, value0, value1, comments, valid_id, queue_id, create_by, create_time, change_by, change_time)
    VALUES
    (1, 'otobo@localhost', 'OTOBO System', 'Standard Address.', 1, 1, 1, current_timestamp, 1, current_timestamp);
# ----------------------------------------------------------
...
INSERT INTO ticket (id, tn, queue_id, ticket_lock_id, user_id, responsible_user_id, ticket_priority_id, ticket_state_id, title, timeout, until_time, escalation_time, escalation_response_time, escalation_update_time, escalation_solution_time, create_by, create_time, change_by, change_time)
    VALUES
    (1, '2015071510123456', 2, 1, 1, 1, 3, 1, 'Welcome to OTOBO!', 0, 0, 0, 0, 0, 0, 1, current_timestamp, 1, current_timestamp);
# ----------------------------------------------------------
...
INSERT INTO article_data_mime (id, article_id, a_from, a_to, a_subject, a_body, a_message_id, incoming_time, content_path, create_by, create_time, change_by, change_time)
    VALUES
    (1, 1, 'OTOBO Feedback <marketing@otobo.com>', 'Your OTOBO System <otobo@localhost>', 'Welcome to OTOBO!', 'Welcome to the OTOBO community!
...
INSERT INTO article_data_mime_plain (id, article_id, body, create_by, create_time, change_by, change_time)
    VALUES
    (1, 1, 'From: OTOBO Feedback <marketing@otobo.com>
...
# ----------------------------------------------------------
INSERT INTO gi_webservice_config (id, name, config, valid_id, create_by, create_time, change_by, change_time)
    VALUES
    (1, 'Elasticsearch', '---
Debugger:
...
# ----------------------------------------------------------
INSERT INTO gi_webservice_config_history (id, config_id, config, config_md5, create_by, create_time, change_by, change_time)
    VALUES
    (1, 1, '---
Debugger:
  DebugThreshold: error
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (1, 1, 'text/plain', 'en', 'Ticket Created: <OTOBO_TICKET_Title>', 'Hi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (2, 2, 'text/plain', 'en', 'Unlocked Ticket Follow-Up: <OTOBO_CUSTOMER_SUBJECT[24]>', 'Hi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (3, 3, 'text/plain', 'en', 'Locked Ticket Follow-Up: <OTOBO_CUSTOMER_SUBJECT[24]>', 'Hi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (4, 4, 'text/plain', 'en', 'Ticket Lock Timeout: <OTOBO_TICKET_Title>', 'Hi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (5, 5, 'text/plain', 'en', 'Ticket Owner Update to <OTOBO_OWNER_UserFullname>: <OTOBO_TICKET_Title>', 'Hi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (6, 6, 'text/plain', 'en', 'Ticket Responsible Update to <OTOBO_RESPONSIBLE_UserFullname>: <OTOBO_TICKET_Title>', 'Hi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (7, 7, 'text/plain', 'en', 'Ticket Note: <OTOBO_AGENT_SUBJECT[24]>', 'Hi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (8, 8, 'text/plain', 'en', 'Ticket Queue Update to <OTOBO_TICKET_Queue>: <OTOBO_TICKET_Title>', 'Hi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (9, 9, 'text/plain', 'en', 'Locked Ticket Pending Reminder Time Reached: <OTOBO_TICKET_Title>', 'Hi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (10, 10, 'text/plain', 'en', 'Unlocked Ticket Pending Reminder Time Reached: <OTOBO_TICKET_Title>', 'Hi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (11, 11, 'text/plain', 'en', 'Ticket Escalation! <OTOBO_TICKET_Title>', 'Hi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (12, 12, 'text/plain', 'en', 'Ticket Escalation Warning! <OTOBO_TICKET_Title>', 'Hi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (13, 13, 'text/plain', 'en', 'Ticket Service Update to <OTOBO_TICKET_Service>: <OTOBO_TICKET_Title>', 'Hi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (14, 14, 'text/html', 'en', 'Reminder: <OTOBO_APPOINTMENT_TITLE>', 'Hi &lt\;OTOBO_NOTIFICATION_RECIPIENT_UserFirstname&gt\;,<br />
<br />
appointment &quot\;&lt\;OTOBO_APPOINTMENT_TITLE&gt\;&quot\; has reached its notification time.<br />
<br />
Description: &lt\;OTOBO_APPOINTMENT_DESCRIPTION&gt\;<br />
Location: &lt\;OTOBO_APPOINTMENT_LOCATION&gt\;<br />
Calendar: <span style="color: &lt\;OTOBO_CALENDAR_COLOR&gt\;\;">■</span> &lt\;OTOBO_CALENDAR_CALENDARNAME&gt\;<br />
Start date: &lt\;OTOBO_APPOINTMENT_STARTTIME&gt\;<br />
End date: &lt\;OTOBO_APPOINTMENT_ENDTIME&gt\;<br />
All-day: &lt\;OTOBO_APPOINTMENT_ALLDAY&gt\;<br />
Repeat: &lt\;OTOBO_APPOINTMENT_RECURRING&gt\;<br />
<br />
<a href="&lt\;OTOBO_CONFIG_HttpType&gt\;://&lt\;OTOBO_CONFIG_FQDN&gt\;/&lt\;OTOBO_CONFIG_ScriptAlias&gt\;index.pl?Action=AgentAppointmentCalendarOverview\;AppointmentID=&lt\;OTOBO_APPOINTMENT_APPOINTMENTID&gt\;" title="&lt\;OTOBO_CONFIG_HttpType&gt\;://&lt\;OTOBO_CONFIG_FQDN&gt\;/&lt\;OTOBO_CONFIG_ScriptAlias&gt\;index.pl?Action=AgentAppointmentCalendarOverview\;AppointmentID=&lt\;OTOBO_APPOINTMENT_APPOINTMENTID&gt\;">&lt\;OTOBO_CONFIG_HttpType&gt\;://&lt\;OTOBO_CONFIG_FQDN&gt\;/&lt\;OTOBO_CONFIG_ScriptAlias&gt\;index.pl?Action=AgentAppointmentCalendarOverview\;AppointmentID=&lt\;OTOBO_APPOINTMENT_APPOINTMENTID&gt\;</a><br />
<br />
-- &lt\;OTOBO_CONFIG_NotificationSenderName&gt\;');
# ----------------------------------------------------------
#  insert into table notification_event_message
# ----------------------------------------------------------
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (15, 1, 'text/plain', 'de', 'Ticket erstellt: <OTOBO_TICKET_Title>', 'Hallo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname> <OTOBO_NOTIFICATION_RECIPIENT_UserLastname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (16, 2, 'text/plain', 'de', 'Nachfrage zum freigegebenen Ticket: <OTOBO_CUSTOMER_SUBJECT[24]>', 'Hallo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname> <OTOBO_NOTIFICATION_RECIPIENT_UserLastname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (17, 3, 'text/plain', 'de', 'Nachfrage zum gesperrten Ticket: <OTOBO_CUSTOMER_SUBJECT[24]>', 'Hallo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname> <OTOBO_NOTIFICATION_RECIPIENT_UserLastname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (18, 4, 'text/plain', 'de', 'Ticketsperre aufgehoben: <OTOBO_TICKET_Title>', 'Hallo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname> <OTOBO_NOTIFICATION_RECIPIENT_UserLastname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (19, 5, 'text/plain', 'de', 'Änderung des Ticket-Besitzers auf <OTOBO_OWNER_UserFullname>: <OTOBO_TICKET_Title>', 'Hallo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname> <OTOBO_NOTIFICATION_RECIPIENT_UserLastname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (20, 6, 'text/plain', 'de', 'Änderung des Ticket-Verantwortlichen auf <OTOBO_RESPONSIBLE_UserFullname>: <OTOBO_TICKET_Title>', 'Hallo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname> <OTOBO_NOTIFICATION_RECIPIENT_UserLastname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (21, 7, 'text/plain', 'de', 'Ticket-Notiz: <OTOBO_AGENT_SUBJECT[24]>', 'Hallo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname> <OTOBO_NOTIFICATION_RECIPIENT_UserLastname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (22, 8, 'text/plain', 'de', 'Ticket-Queue geändert zu <OTOBO_TICKET_Queue>: <OTOBO_TICKET_Title>', 'Hallo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname> <OTOBO_NOTIFICATION_RECIPIENT_UserLastname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (23, 9, 'text/plain', 'de', 'Erinnerungszeit des gesperrten Tickets erreicht: <OTOBO_TICKET_Title>', 'Hallo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname> <OTOBO_NOTIFICATION_RECIPIENT_UserLastname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (24, 10, 'text/plain', 'de', 'Erinnerungszeit des freigegebenen Tickets erreicht: <OTOBO_TICKET_Title>', 'Hallo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname> <OTOBO_NOTIFICATION_RECIPIENT_UserLastname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (25, 11, 'text/plain', 'de', 'Ticket-Eskalation! <OTOBO_TICKET_Title>', 'Hallo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname> <OTOBO_NOTIFICATION_RECIPIENT_UserLastname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (26, 12, 'text/plain', 'de', 'Ticket-Eskalations-Warnung! <OTOBO_TICKET_Title>', 'Hallo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname> <OTOBO_NOTIFICATION_RECIPIENT_UserLastname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (27, 13, 'text/plain', 'de', 'Ticket-Service aktualisiert zu <OTOBO_TICKET_Service>: <OTOBO_TICKET_Title>', 'Hallo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname> <OTOBO_NOTIFICATION_RECIPIENT_UserLastname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (28, 14, 'text/html', 'de', 'Erinnerung: <OTOBO_APPOINTMENT_TITLE>', 'Hallo &lt\;OTOBO_NOTIFICATION_RECIPIENT_UserFirstname&gt\;,<br />
<br />
Termin &quot\;&lt\;OTOBO_APPOINTMENT_TITLE&gt\;&quot\; hat seine Benachrichtigungszeit erreicht.<br />
<br />
Beschreibung: &lt\;OTOBO_APPOINTMENT_DESCRIPTION&gt\;<br />
Standort: &lt\;OTOBO_APPOINTMENT_LOCATION&gt\;<br />
Kalender: <span style="color: &lt\;OTOBO_CALENDAR_COLOR&gt\;\;">■</span> &lt\;OTOBO_CALENDAR_CALENDARNAME&gt\;<br />
Startzeitpunkt: &lt\;OTOBO_APPOINTMENT_STARTTIME&gt\;<br />
Endzeitpunkt: &lt\;OTOBO_APPOINTMENT_ENDTIME&gt\;<br />
Ganztägig: &lt\;OTOBO_APPOINTMENT_ALLDAY&gt\;<br />
Wiederholung: &lt\;OTOBO_APPOINTMENT_RECURRING&gt\;<br />
<br />
<a href="&lt\;OTOBO_CONFIG_HttpType&gt\;://&lt\;OTOBO_CONFIG_FQDN&gt\;/&lt\;OTOBO_CONFIG_ScriptAlias&gt\;index.pl?Action=AgentAppointmentCalendarOverview\;AppointmentID=&lt\;OTOBO_APPOINTMENT_APPOINTMENTID&gt\;" title="&lt\;OTOBO_CONFIG_HttpType&gt\;://&lt\;OTOBO_CONFIG_FQDN&gt\;/&lt\;OTOBO_CONFIG_ScriptAlias&gt\;index.pl?Action=AgentAppointmentCalendarOverview\;AppointmentID=&lt\;OTOBO_APPOINTMENT_APPOINTMENTID&gt\;">&lt\;OTOBO_CONFIG_HttpType&gt\;://&lt\;OTOBO_CONFIG_FQDN&gt\;/&lt\;OTOBO_CONFIG_ScriptAlias&gt\;index.pl?Action=AgentAppointmentCalendarOverview\;AppointmentID=&lt\;OTOBO_APPOINTMENT_APPOINTMENTID&gt\;</a><br />
<br />
-- &lt\;OTOBO_CONFIG_NotificationSenderName&gt\;');
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (29, 1, 'text/plain', 'es_MX', 'Se ha creado un ticket: <OTOBO_TICKET_Title>', 'Hola <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (30, 2, 'text/plain', 'es_MX', 'Seguimiento a ticket desbloqueado: <OTOBO_CUSTOMER_SUBJECT[24]>', 'Hola <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (31, 3, 'text/plain', 'es_MX', 'Seguimiento a ticket bloqueado: <OTOBO_CUSTOMER_SUBJECT[24]>', 'Hola <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (32, 4, 'text/plain', 'es_MX', 'Terminó tiempo de bloqueo: <OTOBO_TICKET_Title>', 'Hola <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (33, 5, 'text/plain', 'es_MX', 'Actualización del propietario de ticket a <OTOBO_OWNER_UserFullname>: <OTOBO_TICKET_Title>', 'Hola <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (34, 6, 'text/plain', 'es_MX', 'Actualización del responsable de ticket a <OTOBO_RESPONSIBLE_UserFullname>: <OTOBO_TICKET_Title>', 'Hola <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (35, 7, 'text/plain', 'es_MX', 'Nota de ticket: <OTOBO_AGENT_SUBJECT[24]>', 'Hola <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (36, 8, 'text/plain', 'es_MX', 'La fila del ticket ha cambiado a <OTOBO_TICKET_Queue>: <OTOBO_TICKET_Title>', 'Hola <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (37, 9, 'text/plain', 'es_MX', 'Recordatorio pendiente en ticket bloqueado se ha alcanzado: <OTOBO_TICKET_Title>', 'Hola <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (38, 10, 'text/plain', 'es_MX', 'Recordatorio pendiente en ticket desbloqueado se ha alcanzado: <OTOBO_TICKET_Title>', 'Hola <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (39, 11, 'text/plain', 'es_MX', '¡Escalación de ticket! <OTOBO_TICKET_Title>', 'Hola <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (40, 12, 'text/plain', 'es_MX', 'Aviso de escalación de ticket! <OTOBO_TICKET_Title>', 'Hola <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (41, 13, 'text/plain', 'es_MX', 'El servicio del ticket ha cambiado a <OTOBO_TICKET_Service>: <OTOBO_TICKET_Title>', 'Hola <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (42, 1, 'text/plain', 'zh_CN', '票据编制 工单已创建：<OTOBO_TICKET_Title>', '您好 <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (43, 2, 'text/plain', 'zh_CN', '解锁票据的后续作业解锁工单的后续： <OTOBO_CUSTOMER_SUBJECT[24]>', '您好<OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (44, 3, 'text/plain', 'zh_CN', '加锁票据的后续作业 锁定工单后续：<OTOBO_CUSTOMER_SUBJECT[24]>', '您好 <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (45, 4, 'text/plain', 'zh_CN', '票据加锁超时工单锁定超时：<OTOBO_TICKET_Title>', '您好 <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (46, 5, 'text/plain', 'zh_CN', '票据的拥有人升级为工单所有者更新为 <OTOBO_OWNER_UserFullname>: <OTOBO_TICKET_Title>', '您好 <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (47, 6, 'text/plain', 'zh_CN', '票据的负责人 工单负责人更新为<OTOBO_RESPONSIBLE_UserFullname>: <OTOBO_TICKET_Title>', '您好 <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (48, 7, 'text/plain', 'zh_CN', '票据备注工单备注：<OTOBO_AGENT_SUBJECT[24]>', '您好 <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (49, 8, 'text/plain', 'zh_CN', '票据序列已升级为工单队列更新为<OTOBO_TICKET_Queue>: <OTOBO_TICKET_Title>', '您好 <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (50, 9, 'text/plain', 'zh_CN', '已达到锁定票据即将到期的提醒时间已到达锁定工单挂起提醒时间：<OTOBO_TICKET_Title>', '您好 <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (51, 10, 'text/plain', 'zh_CN', '未锁定票据即将到期的提醒时间已到已到未锁定工单的挂起提醒时间：<OTOBO_TICKET_Title>', '您好 <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (52, 11, 'text/plain', 'zh_CN', '票据升级！工单升级！<OTOBO_TICKET_Title>', '您好 <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (53, 12, 'text/plain', 'zh_CN', '工单升级警告Ticket Escalation Warning! <OTOBO_TICKET_Title>', '您好  <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (54, 13, 'text/plain', 'zh_CN', '票据服务升级为工单服务更新为<OTOBO_TICKET_Service>: <OTOBO_TICKET_Title>', '您好 <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (55, 1, 'text/plain', 'pt_BR', 'Ticket criado: <OTOBO_TICKET_Title>', 'Oi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (56, 2, 'text/plain', 'pt_BR', 'Acompanhamento do ticket desbloqueado: <OTOBO_CUSTOMER_SUBJECT[24]>', 'Oi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (57, 3, 'text/plain', 'pt_BR', 'Acompanhamento do ticket bloqueado: <OTOBO_CUSTOMER_SUBJECT[24]>', 'Oi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (58, 4, 'text/plain', 'pt_BR', 'Tempo limite de bloqueio do ticket: <OTOBO_TICKET_Title>', 'Oi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (59, 5, 'text/plain', 'pt_BR', 'Atualização de proprietário de ticket para <OTOBO_OWNER_UserFullname>: <OTOBO_TICKET_Title>', 'Oi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (60, 6, 'text/plain', 'pt_BR', 'Atualização de responsável de ticket para <OTOBO_RESPONSIBLE_UserFullname>: <OTOBO_TICKET_Title>', 'Oi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (61, 7, 'text/plain', 'pt_BR', 'Observação sobre o ticket: <OTOBO_AGENT_SUBJECT[24]>', 'Oi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (62, 8, 'text/plain', 'pt_BR', 'Atualização da fila do ticket para <OTOBO_TICKET_Queue>: <OTOBO_TICKET_Title>', 'Oi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (63, 9, 'text/plain', 'pt_BR', 'Tempo de Lembrete de Pendência do Ticket Bloqueado Atingido: <OTOBO_TICKET_Title>', 'Oi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (64, 10, 'text/plain', 'pt_BR', 'Tempo de Lembrete Pendente do Ticket Desbloqueado Atingido: <OTOBO_TICKET_Title>', 'Oi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (65, 11, 'text/plain', 'pt_BR', 'Escalonamento do ticket! <OTOBO_TICKET_Title>', 'Oi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (66, 12, 'text/plain', 'pt_BR', 'Aviso de escalonamento do ticket! <OTOBO_TICKET_Title>', 'Oi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (67, 13, 'text/plain', 'pt_BR', 'Atualização do serviço do ticket para <OTOBO_TICKET_Service>: <OTOBO_TICKET_Title>', 'Oi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (68, 1, 'text/plain', 'hu', 'Jegy létrehozva: <OTOBO_TICKET_Title>', 'Kedves <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>!
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (69, 2, 'text/plain', 'hu', 'Feloldott jegy követése: <OTOBO_CUSTOMER_SUBJECT[24]>', 'Kedves <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>!
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (70, 3, 'text/plain', 'hu', 'Zárolt jegy követése: <OTOBO_CUSTOMER_SUBJECT[24]>', 'Kedves <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>!
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (71, 4, 'text/plain', 'hu', 'Jegyzár időkorlát: <OTOBO_TICKET_Title>', 'Kedves <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>!
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (72, 5, 'text/plain', 'hu', 'Jegytulajdonos frissítés <OTOBO_OWNER_UserLastname> <OTOBO_OWNER_UserFirstname> ügyintézőre: <OTOBO_TICKET_Title>', 'Kedves <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>!
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (73, 6, 'text/plain', 'hu', 'Jegyfelelős frissítés <OTOBO_RESPONSIBLE_UserLastname> <OTOBO_RESPONSIBLE_UserFirstname> ügyintézőre: <OTOBO_TICKET_Title>', 'Kedves <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>!
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (74, 7, 'text/plain', 'hu', 'Új jegyzet: <OTOBO_AGENT_SUBJECT[24]>', 'Kedves <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>!
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (75, 8, 'text/plain', 'hu', 'Jegy várólista frissítés <OTOBO_TICKET_Queue> várólistára: <OTOBO_TICKET_Title>', 'Kedves <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>!
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (76, 9, 'text/plain', 'hu', 'Zárolt jegy „emlékeztető függőben” ideje elérve: <OTOBO_TICKET_Title>', 'Kedves <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>!
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (77, 10, 'text/plain', 'hu', 'Feloldott jegy „emlékeztető függőben” ideje elérve: <OTOBO_TICKET_Title>', 'Kedves <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>!
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (78, 11, 'text/plain', 'hu', 'Jegyeszkaláció! <OTOBO_TICKET_Title>', 'Kedves <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>!
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (79, 12, 'text/plain', 'hu', 'Jegyeszkaláció figyelmeztetés! <OTOBO_TICKET_Title>', 'Kedves <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>!
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (80, 13, 'text/plain', 'hu', 'Jegyszolgáltatás frissítve <OTOBO_TICKET_Service> szolgáltatásra: <OTOBO_TICKET_Title>', 'Kedves <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>!
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (81, 14, 'text/html', 'hu', 'Emlékeztető: <OTOBO_APPOINTMENT_TITLE>', 'Kedves &lt\;OTOBO_NOTIFICATION_RECIPIENT_UserFirstname&gt\;!<br />
<br />
A következő esemény elérte az értesítési idejét: &lt\;OTOBO_APPOINTMENT_TITLE&gt\;<br />
<br />
Leírás: &lt\;OTOBO_APPOINTMENT_DESCRIPTION&gt\;<br />
Hely: &lt\;OTOBO_APPOINTMENT_LOCATION&gt\;<br />
Naptár: <span style="color: &lt\;OTOBO_CALENDAR_COLOR&gt\;\;">■</span> &lt\;OTOBO_CALENDAR_CALENDARNAME&gt\;<br />
Kezdési dátum: &lt\;OTOBO_APPOINTMENT_STARTTIME&gt\;<br />
Befejezési dátum: &lt\;OTOBO_APPOINTMENT_ENDTIME&gt\;<br />
Egész napos: &lt\;OTOBO_APPOINTMENT_ALLDAY&gt\;<br />
Ismétlődés: &lt\;OTOBO_APPOINTMENT_RECURRING&gt\;<br />
<br />
<a href="&lt\;OTOBO_CONFIG_HttpType&gt\;://&lt\;OTOBO_CONFIG_FQDN&gt\;/&lt\;OTOBO_CONFIG_ScriptAlias&gt\;index.pl?Action=AgentAppointmentCalendarOverview\;AppointmentID=&lt\;OTOBO_APPOINTMENT_APPOINTMENTID&gt\;" title="&lt\;OTOBO_CONFIG_HttpType&gt\;://&lt\;OTOBO_CONFIG_FQDN&gt\;/&lt\;OTOBO_CONFIG_ScriptAlias&gt\;index.pl?Action=AgentAppointmentCalendarOverview\;AppointmentID=&lt\;OTOBO_APPOINTMENT_APPOINTMENTID&gt\;">&lt\;OTOBO_CONFIG_HttpType&gt\;://&lt\;OTOBO_CONFIG_FQDN&gt\;/&lt\;OTOBO_CONFIG_ScriptAlias&gt\;index.pl?Action=AgentAppointmentCalendarOverview\;AppointmentID=&lt\;OTOBO_APPOINTMENT_APPOINTMENTID&gt\;</a><br />
<br />
-- &lt\;OTOBO_CONFIG_NotificationSenderName&gt\;');
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (82, 1, 'text/plain', 'sr_Cyrl', 'Oтворен тикет: <OTOBO_TICKET_Title>', 'Здраво <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (83, 2, 'text/plain', 'sr_Cyrl', 'Наставак откључаног тикета: <OTOBO_CUSTOMER_SUBJECT[24]>', 'Здраво <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (84, 3, 'text/plain', 'sr_Cyrl', 'Наставак закључаног тикета: <OTOBO_CUSTOMER_SUBJECT[24]>', 'Здраво <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (85, 4, 'text/plain', 'sr_Cyrl', 'Истек закључаног тикета: <OTOBO_TICKET_Title>', 'Здраво <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (86, 5, 'text/plain', 'sr_Cyrl', 'Промена власника тикета на <OTOBO_OWNER_UserFullname>: <OTOBO_TICKET_Title>', 'Здраво <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (87, 6, 'text/plain', 'sr_Cyrl', 'Промена одговорног за тикет на <OTOBO_RESPONSIBLE_UserFullname>: <OTOBO_TICKET_Title>', 'Здраво <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (88, 7, 'text/plain', 'sr_Cyrl', 'Напомена тикета: <OTOBO_AGENT_SUBJECT[24]>', 'Здраво <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (89, 8, 'text/plain', 'sr_Cyrl', 'Промена реда тикета у <OTOBO_TICKET_Queue>: <OTOBO_TICKET_Title>', 'Здраво <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (90, 9, 'text/plain', 'sr_Cyrl', 'Истек закључаног тикета на чекању: <OTOBO_TICKET_Title>', 'Здраво <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (91, 10, 'text/plain', 'sr_Cyrl', 'Истек откључаног тикета на чекању: <OTOBO_TICKET_Title>', 'Здраво <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (92, 11, 'text/plain', 'sr_Cyrl', 'Ескалација тикета! <OTOBO_TICKET_Title>', 'Здраво <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (93, 12, 'text/plain', 'sr_Cyrl', 'Упозорење на ескалацију тикета! <OTOBO_TICKET_Title>', 'Здраво <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (94, 13, 'text/plain', 'sr_Cyrl', 'Промена сервиса тикета на <OTOBO_TICKET_Service>: <OTOBO_TICKET_Title>', 'Здраво <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (95, 14, 'text/html', 'sr_Cyrl', 'Подсетник: <OTOBO_APPOINTMENT_TITLE>', 'Здраво &lt\;OTOBO_NOTIFICATION_RECIPIENT_UserFirstname&gt\;,<br />
<br />
време је за обавештење у вези термина &quot\;&lt\;OTOBO_APPOINTMENT_TITLE&gt\;&quot\;.<br />
<br />
Опис: &lt\;OTOBO_APPOINTMENT_DESCRIPTION&gt\;<br />
Локација: &lt\;OTOBO_APPOINTMENT_LOCATION&gt\;<br />
Календар: <span style="color: &lt\;OTOBO_CALENDAR_COLOR&gt\;\;">■</span> &lt\;OTOBO_CALENDAR_CALENDARNAME&gt\;<br />
Датум почетка: &lt\;OTOBO_APPOINTMENT_STARTTIME&gt\;<br />
Датум краја: &lt\;OTOBO_APPOINTMENT_ENDTIME&gt\;<br />
Целодневно: &lt\;OTOBO_APPOINTMENT_ALLDAY&gt\;<br />
Понављање: &lt\;OTOBO_APPOINTMENT_RECURRING&gt\;<br />
<br />
<a href="&lt\;OTOBO_CONFIG_HttpType&gt\;://&lt\;OTOBO_CONFIG_FQDN&gt\;/&lt\;OTOBO_CONFIG_ScriptAlias&gt\;index.pl?Action=AgentAppointmentCalendarOverview\;AppointmentID=&lt\;OTOBO_APPOINTMENT_APPOINTMENTID&gt\;" title="&lt\;OTOBO_CONFIG_HttpType&gt\;://&lt\;OTOBO_CONFIG_FQDN&gt\;/&lt\;OTOBO_CONFIG_ScriptAlias&gt\;index.pl?Action=AgentAppointmentCalendarOverview\;AppointmentID=&lt\;OTOBO_APPOINTMENT_APPOINTMENTID&gt\;">&lt\;OTOBO_CONFIG_HttpType&gt\;://&lt\;OTOBO_CONFIG_FQDN&gt\;/&lt\;OTOBO_CONFIG_ScriptAlias&gt\;index.pl?Action=AgentAppointmentCalendarOverview\;AppointmentID=&lt\;OTOBO_APPOINTMENT_APPOINTMENTID&gt\;</a><br />
<br />
-- &lt\;OTOBO_CONFIG_NotificationSenderName&gt\;');
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (96, 1, 'text/plain', 'sr_Latn', 'Otvoren tiket: <OTOBO_TICKET_Title>', 'Zdravo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (97, 2, 'text/plain', 'sr_Latn', 'Nastavak otključanog tiketa: <OTOBO_CUSTOMER_SUBJECT[24]>', 'Zdravo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (98, 3, 'text/plain', 'sr_Latn', 'Nastavak zaključanog tiketa: <OTOBO_CUSTOMER_SUBJECT[24]>', 'Zdravo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (99, 4, 'text/plain', 'sr_Latn', 'Istek zaključanog tiketa: <OTOBO_TICKET_Title>', 'Zdravo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (100, 5, 'text/plain', 'sr_Latn', 'Promena vlasnika tiketa na <OTOBO_OWNER_UserFullname>: <OTOBO_TICKET_Title>', 'Zdravo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (101, 6, 'text/plain', 'sr_Latn', 'Promena odgovornog za tiket na <OTOBO_RESPONSIBLE_UserFullname>: <OTOBO_TICKET_Title>', 'Zdravo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (102, 7, 'text/plain', 'sr_Latn', 'Napomena tiketa: <OTOBO_AGENT_SUBJECT[24]>', 'Zdravo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (103, 8, 'text/plain', 'sr_Latn', 'Promena reda tiketa u <OTOBO_TICKET_Queue>: <OTOBO_TICKET_Title>', 'Zdravo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (104, 9, 'text/plain', 'sr_Latn', 'Istek zaključanog tiketa na čekanju: <OTOBO_TICKET_Title>', 'Zdravo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (105, 10, 'text/plain', 'sr_Latn', 'Istek otključanog tiketa na čekanju: <OTOBO_TICKET_Title>', 'Zdravo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (106, 11, 'text/plain', 'sr_Latn', 'Eskalacija tiketa! <OTOBO_TICKET_Title>', 'Zdravo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (107, 12, 'text/plain', 'sr_Latn', 'Upozorenje na eskalaciju tiketa! <OTOBO_TICKET_Title>', 'Zdravo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (108, 13, 'text/plain', 'sr_Latn', 'Promena servisa tiketa na <OTOBO_TICKET_Service>: <OTOBO_TICKET_Title>', 'Zdravo <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (109, 14, 'text/html', 'sr_Latn', 'Podsetnik: <OTOBO_APPOINTMENT_TITLE>', 'Zdravo &lt\;OTOBO_NOTIFICATION_RECIPIENT_UserFirstname&gt\;,<br />
<br />
vreme je za obaveštenje u vezi termina &quot\;&lt\;OTOBO_APPOINTMENT_TITLE&gt\;&quot\;.<br />
<br />
Opis: &lt\;OTOBO_APPOINTMENT_DESCRIPTION&gt\;<br />
Lokacije: &lt\;OTOBO_APPOINTMENT_LOCATION&gt\;<br />
Kalendar: <span style="color: &lt\;OTOBO_CALENDAR_COLOR&gt\;\;">■</span> &lt\;OTOBO_CALENDAR_CALENDARNAME&gt\;<br />
Datum početka: &lt\;OTOBO_APPOINTMENT_STARTTIME&gt\;<br />
Datum kraja: &lt\;OTOBO_APPOINTMENT_ENDTIME&gt\;<br />
Celodnevno: &lt\;OTOBO_APPOINTMENT_ALLDAY&gt\;<br />
Ponavljanje: &lt\;OTOBO_APPOINTMENT_RECURRING&gt\;<br />
<br />
<a href="&lt\;OTOBO_CONFIG_HttpType&gt\;://&lt\;OTOBO_CONFIG_FQDN&gt\;/&lt\;OTOBO_CONFIG_ScriptAlias&gt\;index.pl?Action=AgentAppointmentCalendarOverview\;AppointmentID=&lt\;OTOBO_APPOINTMENT_APPOINTMENTID&gt\;" title="&lt\;OTOBO_CONFIG_HttpType&gt\;://&lt\;OTOBO_CONFIG_FQDN&gt\;/&lt\;OTOBO_CONFIG_ScriptAlias&gt\;index.pl?Action=AgentAppointmentCalendarOverview\;AppointmentID=&lt\;OTOBO_APPOINTMENT_APPOINTMENTID&gt\;">&lt\;OTOBO_CONFIG_HttpType&gt\;://&lt\;OTOBO_CONFIG_FQDN&gt\;/&lt\;OTOBO_CONFIG_ScriptAlias&gt\;index.pl?Action=AgentAppointmentCalendarOverview\;AppointmentID=&lt\;OTOBO_APPOINTMENT_APPOINTMENTID&gt\;</a><br />
<br />
-- &lt\;OTOBO_CONFIG_NotificationSenderName&gt\;');
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (110, 15, 'text/plain', 'en', 'Email Delivery Failure', 'Hi <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>,
...
INSERT INTO notification_event_message (id, notification_id, content_type, language, subject, text)
    VALUES
    (111, 15, 'text/plain', 'hu', 'E-mail kézbesítési hiba', 'Kedves <OTOBO_NOTIFICATION_RECIPIENT_UserFirstname>!
