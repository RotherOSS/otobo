...
;
BEGIN
    EXECUTE IMMEDIATE 'ALTER TABLE group_user ADD CONSTRAINT FK_group_user_group_id_id FOREIGN KEY (group_id) REFERENCES groups_table (id)';
EXCEPTION
  WHEN OTHERS THEN NULL;
END;
/
...
;
BEGIN
    EXECUTE IMMEDIATE 'ALTER TABLE group_role ADD CONSTRAINT FK_group_role_group_id_id FOREIGN KEY (group_id) REFERENCES groups_table (id)';
EXCEPTION
  WHEN OTHERS THEN NULL;
END;
/
...
;
BEGIN
    EXECUTE IMMEDIATE 'ALTER TABLE group_customer_user ADD CONSTRAINT FK_group_customer_user_groupbb FOREIGN KEY (group_id) REFERENCES groups_table (id)';
EXCEPTION
  WHEN OTHERS THEN NULL;
END;
/
...
;
BEGIN
    EXECUTE IMMEDIATE 'ALTER TABLE group_customer ADD CONSTRAINT FK_group_customer_group_id_id FOREIGN KEY (group_id) REFERENCES groups_table (id)';
EXCEPTION
  WHEN OTHERS THEN NULL;
END;
/
...
;
BEGIN
    EXECUTE IMMEDIATE 'ALTER TABLE queue ADD CONSTRAINT FK_queue_group_id_id FOREIGN KEY (group_id) REFERENCES groups_table (id)';
EXCEPTION
  WHEN OTHERS THEN NULL;
END;
/
...
;
BEGIN
    EXECUTE IMMEDIATE 'ALTER TABLE ticket_index ADD CONSTRAINT FK_ticket_index_group_id_id FOREIGN KEY (group_id) REFERENCES groups_table (id)';
EXCEPTION
  WHEN OTHERS THEN NULL;
END;
/
...
;
BEGIN
    EXECUTE IMMEDIATE 'ALTER TABLE calendar ADD CONSTRAINT FK_calendar_group_id_id FOREIGN KEY (group_id) REFERENCES groups_table (id)';
EXCEPTION
  WHEN OTHERS THEN NULL;
END;
/
