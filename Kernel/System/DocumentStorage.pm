...
package Kernel::System::DocumentStorage;
...
Kernel::System::DocumentStorage - store and retrieve documents

=head1 DESCRIPTION

Functions to access document_storage
...
Don't use the constructor directly, use the ObjectManager instead:
    ...
    my $DocumentStorageObject = $Kernel::OM->Get('Kernel::System::DocumentStorage');
...
Store a new document
    ...
    my $ID = $DocumentStorageObject->AddDocument(
        Key     => 'Dashboard::Info',
        SubKey  => '', # optional
        ID      => 'Test_abc2',
        Config  => $HashRef, # optional
        Content => $Content,
        UserID  => $UserID,
    );
