...
package Kernel::System::Console::Command::Znuny4OTOBO::DefaultColumnsScreen::Add;
...
sub Configure {
    ...
    $Self->Description("Updates the 'DynamicField' config of all DefaultColumnsScreens configs accordingly");
