...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'It is highly recommended to send this data to OTOBO Team in order to get better support.' =>
            'Sangat di rekomendasikan untuk mengirimdata ini kepada Grup OTOBO agar mendapatkan bantuan yang lebih baik.',
        'Configuration' => 'konfigurasi',
        'Send support data' => 'Kirimkan data pendukung',
        'This will allow the system to send additional support data information to OTOBO Team.' =>
            'Ini akan mengizinkan system untuk mengirimkan informasi data pendukung tambahan kepada Grup OTOBO',
        'Update' => 'Pembaruan',
        'System Registration' => 'Pendaftaran sistem',
        'To enable data sending, please register your system with OTOBO Team or update your system registration information (make sure to activate the \'send support data\' option.)' =>
            'Untuk mengaktifkan pengiriman data, mohon untuk mendaftarkan sistem anda dengan Grup OTOBO atau perbarui informasi pendaftaran sistem anda (pastikan untuk mengaktifkan  pilihan \'Kirimkan data pendukung\')',
        ...
        'System registration is a service of OTOBO Team, which provides a lot of advantages!' =>
            'Pendaftaran sistem adalah layanan dari Grup OTOBO, yang memberikan banyak keuntungan!',
        ...
        'Connection to cloud.otrs.com via HTTPS couldn\'t be established. Please make sure that your OTOBO can connect to cloud.otrs.com via port 443.' =>
            'Koneksi ke cloud.otrs.com melalui HTTPS tidak dapat ditentukan. Pastikan bahwa OTOBO anda dapat terhubung ke cloud.otrs.com melalui port 443.',
        ...
        'You will receive updates for all other relevant OTOBO issues' => 'Anda akan menerima pembaruan untuk semua isu OTOBO yang relevan',
        ...
        'Go to OTOBO Package Manager' => 'Pergi ke OTOBO paket manajer',
        ...
        'To be able to use PGP in OTOBO, you have to enable it first.' => 'Untuk dapat menggunakan PGP di OTOBO, Anda harus mengaktifkannya terlebih dahulu.',
...
EMAILADDRESS:info@example.com dari, kepada atau Cc.',
        ...
        'This system is registered with OTOBO Team.' => 'Sistem ini telah terdaftar oleh grup OTOBO',
        ...
        'A registered system sends the following data to OTOBO Team:' => 'Sebuah sistem yang terdaftar akan mengirimkan data berikut untuk grup OTOBO',
        ...
        'This data will be frequently transferred to OTOBO Team when you register this system.' =>
            'Data ini akan sering dialihkan ke OTOBO Grup saat anda mendaftar sistem ini.',
        'Attribute' => 'Atribut',
        'FQDN' => 'FQDN',
        ...
        'Continuing with this step will deregister the system from OTOBO Team.' =>
            'Melanjutkan dengan langkah berikut akan mempengaruhi deregister dari grup OTOBO',
        ...
        'Sending support data to OTOBO Team is not possible!' => 'Mengirimkan dukungan data ke dalam grup OTOBO tidak didapati',
        'Enable Cloud Services' => 'Mengadakan layanan cloud',
        'This data is sent to OTOBO Team on a regular basis. To stop sending this data please update your system registration.' =>
            'Data ini dihantar ke grup OTOBO dalam basis yang sederhana. Untuk menghentikan data ini, silahkan perbarui system pendaftaran anda',
        ...
        'The support bundle will be sent to OTOBO Team via email automatically.' =>
            'Pendukung bundel akan menghantar ke grup OTOBO melalui email dengan otomatis',
        'Download File' => 'Memuat turun file',
        'A file containing the support bundle will be downloaded to the local system. Please save the file and send it to the OTOBO Team, using an alternate method.' =>
            'Sebuah file yang berisi dukungan bundel akan di-download ke sistem lokal. Harap menyimpan file dan mengirimkannya ke grup OTOBO,  denganmenggunakan metode alternatif.',
...
bin/otobo.Daemon.pl status\').',
        ...
        'Really a bug? 5 out of 10 bug reports result from a wrong or incomplete installation of OTOBO.' =>
            'Benar-benar bug? 5 dari 10 laporan bug hasil dari instalasi yang salah atau tidak lengkap dari OTOBO.',
        ...
        'Package not verified by the OTOBO Team! It is recommended not to use this package.' =>
            'Paket tidak di verifikasi oleh OTOBO grup! Tidak di rekomendasikan untuk menggunakan paket ini.',
        'Not Started' => '',
        'Updated' => '',
        'Already up-to-date' => '',
        'Installed' => '',
        ...
        'Enable cloud services to unleash all OTOBO features!' => 'Mengaktifkan layanan cloud untuk melepaskan semua fitur OTOBO!',
...
',
        ...
        'Configures a default TicketDynamicField setting. "Name" defines the dynamic field which should be used, "Value" is the data that will be set, and "Event" defines the trigger event. Please check the developer manual (https://doc.otobo.org/doc/), chapter "Ticket Event Module".' =>
            'Mengkonfigurasi TicketDynamicField pengaturan default. "Nama" mendefinisikan bidang yang dinamis yang harus digunakan, "Value" adalah data yang akan ditetapkan, dan "Event" mendefinisikan acara pemicu. Silakan periksa pengembang user (https://doc.otobo.org/doc/), bab "Ticket acara Modul".',
        ...
        'Defines the default front-end (HTML) theme to be used by the agents and customers. If you like, you can add your own theme. Please refer the administrator manual located at https://doc.otobo.org/doc/.' =>
            'Mendefinisikan default front-end (HTML) tema yang akan digunakan oleh agen dan pelanggan. Jika Anda suka, Anda dapat menambahkan tema Anda sendiri. Silahkan lihat manual administrator yang terletak di https://doc.otobo.org/doc/.',
