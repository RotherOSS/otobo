...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'This will allow the system to send additional support data information to OTOBO Team.' =>
            'Ciò consentirà al sistema di inviare dati di supporto aggiuntivi a OTOBO Team.',
        'Update' => 'Aggiorna',
        ...
        'Connection to cloud.otrs.com via HTTPS couldn\'t be established. Please make sure that your OTOBO can connect to cloud.otrs.com via port 443.' =>
            'La connessione a cloud.otrs.com tramite HTTPS non può essere stabilita. Assicurati che il tuo OTOBO possa connettersi a cloud.otrs.com tramite la porta 443.',
...
' => '',
        ...
        'Czech' => 'Ceco',
        'Danish' => 'Danese',
        'Dashboard overview.' => 'Panoramica dashboard.',
        ...
        'Sends registration information to OTOBO group.' => 'Invia le informazioni di registrazione a OTOBO Team.',
