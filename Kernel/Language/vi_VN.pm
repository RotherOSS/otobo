...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'It is highly recommended to send this data to OTOBO Team in order to get better support.' =>
            'Chúng tối khuyến nghị gửi dữ liệu này đến Nhóm OTOBO để hỗ trợ tốt hơn.',
        'Configuration' => 'Cấu h',
        ...
        'Package not verified by the OTOBO Team! It is recommended not to use this package.' =>
            'Gói không được xác nhận bởi tập đoàn OTOBO! Đó là khuyến cáo không sử dụng gói này.',
        'Not Started' => '',
        'Updated' => '',
        'Already up-to-date' => '',
        'Installed' => '',
