...
sub Data {
    ...
    $Self->{Completeness}        = 0.221663693854386;
    ...
    $Self->{Translation}       = {
        ...
        'Sent password reset instructions. Please check your email.' =>
            'Slaptažodžio atstatymo instrukcijos išsiųstos. Prašome pasitikrinti savo el. paštą.',
...
' => '',
        ...
        'Please click the button below to create your first ticket.' =>
            'Prašome paspausti žemiau esantį mytuką, kad sukurtumėte savo pirmąjį trikties pranešimą.',
        'Plugin search'                            => '',
