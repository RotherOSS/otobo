...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Really a bug? 5 out of 10 bug reports result from a wrong or incomplete installation of OTOBO.' =>
            'Opravdu chyba? 5 z 10 hlášení o chybách je důsledek nesprávné nebo neúplné instalace OTOBO.',
        ...
        'Enable cloud services to unleash all OTOBO features!' => 'Povolit cloudové služby pro využití všech možností OTOBO!',
