...
sub Data {
    ...
    $Self->{Completeness}        = 0.298303558024321;
    ...
    $Self->{Translation} = {
        ...
        'Import/Export Management' => '導入/導出管理',
        'Add template' => '添加模板',
        'Create a template to import and export object information.' => '創建模板導入和導出對象信息。',
        ...
        'No map elements found.' => '沒有找到映射的字段',
        'Up' => '上',
        'Down' => '下',
        'Add Mapping Element' => '添加映射字段',
        'Step 5 of 5 - Edit search information' => '',
        'Template Name' => '模板名稱',
        'Restrict export per search' => '限制導出每個搜尋',
        'Finish' => '完成',
        'Import information' => '導入信息',
        'Source File' => '源文件',
        'Import summary for %s' => '',
        'Records' => '紀錄',
        'Success' => '成功',
        'Failed' => '失敗',
        'Duplicate names' => '重複的名稱',
        'Last processed line number of import file' => '導入文件最後處理的行數',
        'Ok' => 'Ok',
...
請注意，更換頭像需要一點時間才會生效。',
        ...
        'Tabulator (TAB)' => '制表鍵 (TAB)',
        'Semicolon (;)' => '分號 (;)',
        'Colon (:)' => '冒號 (:)',
        'Dot (.)' => '句號 (.)',
        'Comma (,)' => '',
        'Charset' => '字符集',
        'Include Column Headers' => '包括列標題',
        'Column' => '列',
...
' => '',
        ...
        'Your email with ticket number "<OTOBO_TICKET>" is merged to "<OTOBO_MERGE_TO_TICKET>".' =>
            '您的單號為"<OTOBO_TICKET>"的郵件工單 被合併到單號"<OTOBO_MERGE_TO_TICKET>" !',
