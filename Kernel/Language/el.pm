...
sub Data {
    ...
    $Self->{Completeness}        = 0.146838885112169;
...
επεξεργαστείτε τα πιστοποιητικά και ιδιωτικά κλειδιά στο αρχείο συστήματος.',
        ...
        'Package not verified by the OTOBO Team! It is recommended not to use this package.' =>
            'Το πακέτο δεν έχει επαληθευτεί από την ομάδα OTOBO! Προτείνεται να μην χρησιμοποιηθεί αυτό το πακέτο.',
        'Not Started' => '',
        'Updated' => '',
        'Already up-to-date' => '',
        'Installed' => '',
        ...
        'Enable cloud services to unleash all OTOBO features!' => 'Ενεργοποίηση των υπηρεσιών cloud για τα πλήρη χαρακτηριστικά του OTOBO!',
