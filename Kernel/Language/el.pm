...
επεξεργαστείτε τα πιστοποιητικά και ιδιωτικά κλειδιά στο αρχείο συστήματος.',
        ...
        'Address %s replaced with registered customer address.' =>
            'Η διεύθυνση %s έχει αντικατασταθεί με την καταχωρημένη διεύθυνση του πελάτη.',
        ...
        'Enter the password for the administrative database user.' =>
            'Εισάγετε το συνθηματικό του διαχειριστή της βάσης δεδομένων.',
        ...
        'Database already contains data - it should be empty!' =>
            'Η βάση περιέχει ήδη δεδομένα - θα πρέπει να παραμείνει κενή!',
        ...
        'The current password is not correct. Please try again!' =>
            'Το συνθηματικό δεν είναι σωστό. Παρακαλούμε δοκιμάστε ξανά!',
        ...
        'Can\'t update password, it must contain at least 1 digit!' =>
            'Δεν είναι δυνατή η ενημέρωση του συνθηματικού, γιατί πρέπει να περιέχει τουλάχιστον 1 αριθμό!',
        ...
        'Session limit reached! Please try again later.' =>
            'Το χρονικό όριο της σύνδεσης έχει εξαντληθεί! Παρακαλούμε προσπαθήστε ξανά αργότερα.',
        'Session per user limit reached!' => '',

        # Perl Module: Kernel/System/AuthSession/DB.pm
        'Session invalid. Please log in again.'       => 'Η σύνδεση δεν ήταν εφικτή. Παρακαλούμε συνδεθείτε ξανά.',
        'Session has timed out. Please log in again.' =>
            'Εξαντλήθηκε το χρονικό όριο σύνδεσης. Παρακαλούμε συνδεθείτε ξανά.',
        ...
        'Can\'t contact registration server. Please try again later.' =>
            'Δεν είναι δυνατή η σύνδεση με τον διακομιστή. Παρακαλούμε ξαναπροσπαθήστε αργότερα.',
        'No content received from registration server. Please try again later.' =>
            'Δεν είναι δυνατή η σύνδεση με τον διακομιστή. Παρακαλώ ξαναπροσπαθήστε αργότερα.',
        'Can\'t get Token from sever'                           => '',
        'Username and password do not match. Please try again.' =>
            'Το συνθηματικό σας δεν είναι σωστό. Παρακαλούμε δοκιμάστε ξανά!',
        'Problems processing server result. Please try again later.' =>
            'Προέκυψαν σφάλματα κατά την επεξεργασία του αποτελέσματος στον διακομιστή. Παρακαλούμε ξαναπροσπαθήστε αργότερα.',
        ...
        'Tables found which are not present in the database.' =>
            'Βρέθηκαν πίνακες που δεν υφίστανται στην βάση δεδομένων.',
        ...
        'There should be more than 60% free swap space.' =>
            'Θα πρέπει να υπάρχει περισσότερη απο 60% ελεύθερη χωρητικότητα swap.',
        ...
        'Sent password reset instructions. Please check your email.' =>
            'Έγινε αποστολή οδηγιών επαναφοράς συνθηματικού. Παρακαλούμε ελέγξτε το email σας.',
        'Invalid Token!'                                    => 'Άκυρο token',
        'Sent new password to %s. Please check your email.' =>
            'Απεστάλη νέο συνθηματικό στο %s. Παρακαλούμε ελέγξτε το email σας.',
...
' => '',
        ...
        'All new tickets, these tickets have not been worked on yet' =>
            'Όλα τα νέα δελτία, όσα δεν έχουν ακόμη επεξεργαστεί',
