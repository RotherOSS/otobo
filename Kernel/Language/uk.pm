...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'It is highly recommended to send this data to OTOBO Team in order to get better support.' =>
            'Дуже рекомендується надіслати ці дані до групи OTOBO з метою отримати кращу підтримку.',
        'Configuration' => 'Налаштування',
        'Send support data' => 'Надсилати дані підтримки',
        'This will allow the system to send additional support data information to OTOBO Team.' =>
            'Це дозволить системі надсилати додаткову інформацію даних підтримки до групи OTOBO.',
        'Update' => 'Оновити',
        'System Registration' => 'Реєстрація системи',
        'To enable data sending, please register your system with OTOBO Team or update your system registration information (make sure to activate the \'send support data\' option.)' =>
            'Щоб увімкнути надсилання, будь ласка, зареєструйте Вашу систему у групі OTOBO, або оновіть Вашу інформацію реєстрації системи (переконайтесь, що опцію «надсилати дані підтримки» активовано).',
        ...
        'System registration is a service of OTOBO Team, which provides a lot of advantages!' =>
            'Реєстрація системи — це сервіс групи OTOBO, який надає багато переваг!',
        ...
        'Connection to cloud.otrs.com via HTTPS couldn\'t be established. Please make sure that your OTOBO can connect to cloud.otrs.com via port 443.' =>
            'Неможливо встановити з\'єднання із cloud.otrs.com за допомогою HTTPS. Будь ласка, переконайтеся в тому, що ваш OTOBO може під\'єднатися до cloud.otrs.com використовуючи порт 443.',
        'Package installation requires patch level update of OTOBO.' => 'Встановлення пакунка потребує оновлення рівня виправлень OTOBO.',
        ...
        'Your installed OTOBO version is %s.' => 'Версія вашого встановленого OTOBO %s.',
        'To install this package, you need to update to OTOBO %s or higher.' =>
            'Щоб встановити цей пакунок, вам необхідно оновитись до OTOBO %s або вище.',
        'To install this package, the Maximum OTOBO Version is %s.' => 'Максимальна версія OTOBO для встановлення цього пакунку, це %s.',
        ...
        'You will receive updates for all other relevant OTOBO issues' => 'Ви будете отримувати оновлення для всіх інших відповідних питань OTOBO',
        ...
        'Go to OTOBO Package Manager' => 'Перейти до менеджера пакунків OTOBO',
        ...
        'To be able to use PGP in OTOBO, you have to enable it first.' => 'Щоб мати змогу використовувати PGP в OTOBO ви повинні спочатку увімкнути його.',
        ...
        'Package installation requires a patch level update of OTOBO.' => 'Установка пакунку потребує оновлення рівня виправлень OTOBO.',
        ...
        'Really a bug? 5 out of 10 bug reports result from a wrong or incomplete installation of OTOBO.' =>
            'Справді помилка? 5 з 10 повідомлень про помилку пов\'язани з неправильним або неповним встановленням OTOBO.',
        ...
        'Enable cloud services to unleash all OTOBO features!' => 'Ввімкніть хмарні сервіси щоб розкрити усі можливості OTOBO!',
