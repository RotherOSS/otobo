...
sub Data {
    ...
    $Self->{Completeness}        = 0.245338089832982;
    ...
    $Self->{Translation}       = {
        ...
        'Activate this option to create an empty selectable value.' =>
            'Activează această opțiune pentru a crea o valoare ce poate fi selectată și este goală.',
        ...
        'Can\'t contact registration server. Please try again later.' =>
            'Nu se poate realiza o conexiune la serverul de înregistrare. Vă rugăm să încercați mai târziu.',
        ...
        'Problems processing server result. Please try again later.' =>
            'Au apărut probleme în procesarea informațiilor de la server. Vă rugăm să încercați mai târziu.',
        ...
        'Sent password reset instructions. Please check your email.' =>
            'Instrucțiunile pentru schimbarea parolei au fost trimise. Vă rog să vă verificați adresa de email.',
...
' => '',
        ...
        'New process ticket'         => '',
        'News about OTOBO releases!' => 'Noutăți despre noile versiuni ale OTOBO!',
        'News about OTOBO.'          => '',
