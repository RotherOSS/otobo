...
sub Data {
    ...
    $Self->{Completeness}        = 0.232547665515688;
    ...
    $Self->{Translation} = {
        ...
        'Here you can specify the maximum size (in bytes) of REST messages that OTOBO will process.' =>
            'Aici puteți specifica dimensiunea maximă (în octeți) a mesajelor tip REST pe care le va procesa OTOBO.',
        ...
        'The full path and name of the certification authority certificate file that validates SSL certificate.' =>
            '',
        'e.g. /opt/otobo/var/certificates/SOAP/CA/ca.pem' => 'de ex. /opt/otobo/var/certificates/SOAP/CA/ca.pem',
        ...
        'Here you can specify the maximum size (in bytes) of SOAP messages that OTOBO will process.' =>
            'Aici puteți scpecifica mărimea maximă (în octeți) a mesajelor SOAP pe care le va procesa OTOBO.',
        'Encoding' => 'Codare',
        ...
        'In provider mode, OTOBO offers web services which are used by remote systems.' =>
            'În modul furnizor OTOBO oferă servicii web ce sunt folosite de alte sisteme.',
        'In requester mode, OTOBO uses web services of remote systems.' =>
            'În modul client OTOBO folosește servicii web furnizate de alte sisteme.',
        ...
        'Import/Export Management' => 'Management import/export',
        'Add template' => '',
        'Create a template to import and export object information.' => 'Crează un șablon pentru import/export informații obiecte.',
        ...
        'Step 1 of 5 - Edit common information' => 'Pasul 1 din 5 - Editează informații generale',
        'Name is required!' => 'Este necesara introducerea numelui!',
        'Object is required!' => 'Obiectul este cerut!',
        'Format is required!' => 'Formatul este cerut!',
        'Next' => 'Următorul',
        'Step 2 of 5 - Edit object information' => 'Pasul 2 din 5 - Editează informații despre obiect',
        'Back' => 'Înapoi',
        'Step 3 of 5 - Edit format information' => 'Pasul 3 din 5 - Editeaza informații despre format',
        'is required!' => 'este obligatoriu!',
        'Step 4 of 5 - Edit mapping information' => 'Pasul 4 din 5 - Editează informații despre asocieri',
        'No map elements found.' => 'Nu au fost găsite elemente de asociere.',
        'Up' => 'Sus',
        'Down' => 'Jos',
        'Add Mapping Element' => 'Adaugă element de asociere',
        'Step 5 of 5 - Edit search information' => 'Pasul 5 din 5 - Editează informații de căutare',
        'Template Name' => 'Nume șablon',
        'Restrict export per search' => 'Limitează exportul la rezultatele căutarii',
        'Finish' => '',
        'Import information' => 'Importă informațiile',
        'Source File' => 'Fișier sursă',
        'Import summary for %s' => 'Rezumat import pentru %s',
        'Records' => 'Înregistrări',
        'Success' => 'Succes',
        'Failed' => 'Nereușit',
        'Duplicate names' => 'Nume duplicate',
        'Last processed line number of import file' => 'Numărul ultimei linii procesate din fișierul de import',
        'Ok' => '确定',
        ...
        'OTOBO as provider' => 'OTOBO ca și furnizor',
        'Operations' => '',
        'OTOBO as requester' => 'OTOBO ca și client',
        'Invokers' => '',
        ...
        'Template not found!' => '',
        'Can\'t insert/update template!' => 'Nu se poate introduce/actualiza șablon!',
        'Needed TemplateID!' => 'Necesar ID Șablon!',
        'Error occurred. Import impossible! See Syslog for details.' => 'Eroare. Import imposibil! Vezi Syslog pentru detalii.',
        'Error occurred. Export impossible! See Syslog for details.' => 'Eroare. Export imposibil! Vezi Syslog pentru detalii.',
        'Template List' => 'Listă Șabloane',
        'number' => 'numar',
        'number bigger than zero' => 'numar mai mare ca zero',
        'integer' => 'întreg',
        'integer bigger than zero' => 'întreg mai mare ca zero',
        'Element required, please insert data' => 'Element necesar, te rog sa introduci datele',
        'Invalid data, please insert a valid %s' => 'Date invalide, introdu date valide %s',
        'Format not found!' => 'Formatul nu a fost gasit!',
        ...
        'Install OTOBO' => 'Instalează OTOBO',
        'Intro' => 'Introducere',
        ...
        'OTOBO Daemon is not running.' => 'Serviciul OTOBO nu ruleaza',
        ...
        'Include Column Headers' => 'Include capul de tabel',
        'Column' => 'Coloană',
        ...
        'OTOBO Disk Partition' => 'Partiția discului OTOBO',
        ...
        'The file system on your OTOBO partition is not writable.' => 'Sistemul de fișiere de pe partiția OTOBO nu este accesibil pentru scriere.',
...
' => '',
        ...
        'Import and export object information.' => 'Informații de import/export ale obiectului.',
        ...
        'Your email with ticket number "<OTOBO_TICKET>" is bounced to "<OTOBO_BOUNCE_TO>". Contact this address for further information.' =>
            'e-mailul d-voastra cu numarul de tichet "<OTOBO_TICKET>" este redirectionat catre <OTOBO_BOUNCE_TO>". Va rugam sa contactati aceasta adresa pentru informatii suplimentare.',
        'Your email with ticket number "<OTOBO_TICKET>" is merged to "<OTOBO_MERGE_TO_TICKET>".' =>
            'Emialul dumneavoastră cu numărul tichetului "<OTOBO_TICKET>" a fost inglobat tichetului "<OTOBO_MERGE_TO_TICKET>".',
