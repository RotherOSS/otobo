...
sub Data {
    ...
    $Self->{Completeness}        = 0.265431049141302;
    ...
    $Self->{Translation} = {
        ...
        'e.g urn:otobo-com:soap:functions or http://www.otrs.com/GenericInterface/actions' =>
            'de ex. urn:otobo-com:soap:functions sau http://www.otrs.com/GenericInterface/actions',
        ...
        'The partition where OTOBO is located is almost full.' => 'Partiția pe care se află OTOBO este aproape plină.',
        'The partition where OTOBO is located has no disk space problems.' =>
            'Nu sunt probleme de spațiu pe partiția pe care se află OTOBO.',
