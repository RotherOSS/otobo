...
sub Data {
    ...
    $Self->{Completeness}        = 0.323419442556084;
    ...
    $Self->{Translation} = {
        ...
        'It is highly recommended to send this data to OTOBO Team in order to get better support.' =>
            'É bastante recomendável enviar estes dados para o Grupo OTOBO para obter um melhor apoio.',
        'Configuration' => 'Configuração',
        'Send support data' => 'Enviar dados de suporte',
        'This will allow the system to send additional support data information to OTOBO Team.' =>
            'Isso permite que o sistema envie informações de dados de suporte adicionais para o Groupo OTOBO.',
        'Update' => 'Atualizar',
        'System Registration' => 'Registo de Sistema',
        'To enable data sending, please register your system with OTOBO Team or update your system registration information (make sure to activate the \'send support data\' option.)' =>
            'Para permitir o envio de dados, por favor registe o seu sistema no Group OTOBO ou atualize a informação de registo do sistema (confirme que a opção \'Enviar dados de suporte\' está ativa)',
        ...
        'Go to OTOBO Package Manager' => 'Voltar à página de gestão de pacotes do OTOBO',
        ...
        'Package not verified by the OTOBO Team! It is recommended not to use this package.' =>
            'O Pacote não foi verificado pelo Groupo OTOBO! Não é recomendado utilizar o Pacote.',
        'Not Started' => '',
        'Updated' => '',
        'Already up-to-date' => '',
        'Installed' => '',
        ...
        'Enable cloud services to unleash all OTOBO features!' => 'Active os serviços cloud para desbloquear todas as funcionalidades OTOBO!',
