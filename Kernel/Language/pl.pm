...
sub Data {
    ...
    $Self->{Completeness}        = 0.667913620132631;
    ...
    $Self->{Translation} = {
        ...
        'It is highly recommended to send this data to OTOBO Team in order to get better support.' =>
            'Jest wysoce zalecanym by wysłać te dane do Grupy OTOBO w celu uzyskania lepszego wsparcia.',
        'Configuration' => 'Konfiguracja',
        'Send support data' => 'Wysyłaj dane wsparcia',
        'This will allow the system to send additional support data information to OTOBO Team.' =>
            'Pozwala na przesyłanie dodatkowych danych do grupy wsparcia OTOBO',
        'Update' => 'Zaktualizuj',
        'System Registration' => 'Rejestracja systemu',
        'To enable data sending, please register your system with OTOBO Team or update your system registration information (make sure to activate the \'send support data\' option.)' =>
            'Aby włączyć przesyłanie danych, zarejestruj swój system w Grupie OTOBO lub zaktualizuj informacje rejestracyjne systemu (upewnij się że opcja \'wysyłaj dane wsparcia\' jest akywna).',
        ...
        'System registration is a service of OTOBO Team, which provides a lot of advantages!' =>
            'System rejestracji jest serwisem grupy OTOBO, kóry posiada wiele zalet!',
...
"CustomerGroupCompanyAlwaysGroups".',
        ...
        'Connection to cloud.otrs.com via HTTPS couldn\'t be established. Please make sure that your OTOBO can connect to cloud.otrs.com via port 443.' =>
            'Połączenie do cloud.otrs.com przez HTTPS nie mogło zostać zestawione. Upewnij się, że Twój OTOBO może podłączyć się do cloud.otrs.com po 443 porcie.',
        'Package installation requires patch level update of OTOBO.' => 'Instalacja pakietu wymaga zastosowania odpowiedniego poziomu aktualizacji OTOBO',
        'Please visit our customer portal and file a request.' => '',
        'Everything else will be done as part of your contract.' => '',
        'Your installed OTOBO version is %s.' => 'Twoja zainstalowana wersja OTOBO to %s',
        ...
        'Go to OTOBO Package Manager' => 'Przejdź do menedżera pakietów OTOBO',
        ...
        'To be able to use PGP in OTOBO, you have to enable it first.' => 'Aby móc używać PGP w OTOBO musisz najpierw włączyć dla niego wsparcie.',
        ...
        'Package installation requires a patch level update of OTOBO.' => 'Instalacja pakietu wymaga zastosowania odpowiedniego poziomu aktualizacji OTOBO',
        ...
        'This system is registered with OTOBO Team.' => 'Ten system jest zarejestrowany w grupie OTOBO.',
        ...
        'A registered system sends the following data to OTOBO Team:' => 'Zarejestrowany system wysyła następujące dane do Grupy OTOBO:',
        ...
        'This data will be frequently transferred to OTOBO Team when you register this system.' =>
            'następujące dane będą przesyłane do Grupy OTOBO gdy zarejestrujesz system.',
        'Attribute' => 'Atrybut',
        'FQDN' => 'FQDN',
        ...
        'Continuing with this step will deregister the system from OTOBO Team.' =>
            'Kontynuacja tego kroku spowoduje wyrejestrowanie systemu z Grupy OTOBO',
        ...
        'The support bundle will be sent to OTOBO Team via email automatically.' =>
            'Pakiet serwisowy zostanie automatycznie wysłany e-mailem do Grupy OTOBO',
        'Download File' => 'Pobierz plik',
        ...
        'Package not verified by the OTOBO Team! It is recommended not to use this package.' =>
            'Pakiet nie został zweryfikowany przez Grupę OTOBO! Zalecamy nie korzystanie z tego pakietu.',
        'Not Started' => '',
        'Updated' => '',
        'Already up-to-date' => '',
        ...
        'Enable cloud services to unleash all OTOBO features!' => 'W celu uruchomienia wszystkich funkcji OTOBO włącz usługi w chmurze!',
