...
sub Data {
    ...
    $Self->{Completeness}        = 0.571549966009517;
    ...
    $Self->{Translation} = {
        ...
        'It is highly recommended to send this data to OTOBO Team in order to get better support.' =>
            'Se recomienda ampliamente que envié estos datos al Grupo OTOBO con el fin de obtener un mejor soporte.',
        'Configuration' => 'Configuración',
        'Send support data' => 'Enviar datos de soporte',
        'This will allow the system to send additional support data information to OTOBO Team.' =>
            'Esto permitirá al sistema enviar información de datos adicionales de soporte al Grupo OTOBO.',
        'Update' => 'Actualizar',
        'System Registration' => 'Registro del Sistema',
        'To enable data sending, please register your system with OTOBO Team or update your system registration information (make sure to activate the \'send support data\' option.)' =>
            'Para habilitar el envío de datos, registre su sistema con Grupo OTOBO o actualice la información de registro de su sistema ( asegúrese de activar la opción \'enviar datos de soporte\'.)',
        ...
        'System registration is a service of OTOBO Team, which provides a lot of advantages!' =>
            '!El registro del sistema es un servicio de Grupo OTOBO, el cual provee innumerables ventajas!',
        ...
        'Go to OTOBO Package Manager' => 'Ir al Gestor de Paquetes OTOBO',
        ...
        'To be able to use PGP in OTOBO, you have to enable it first.' => 'Para poder utilizar PGP en OTOBO, es necesario habilitarlo primero.',
        ...
        'OTOBO Verify can not continue!' => '¡OTOBO Verity™ no puede continuar!',
        ...
        'This system is registered with OTOBO Team.' => 'Este sistema se encuentra registrado con Grupo OTOBO',
        ...
        'Package not verified by the OTOBO Team! It is recommended not to use this package.' =>
            'El paquete no ha sido verificado por el Grupo OTOBO! Se recomienda no utilizar este paquete.',
        'Not Started' => '',
        'Updated' => '',
        'Already up-to-date' => '',
        'Installed' => '',
        ...
        'Enable cloud services to unleash all OTOBO features!' => 'Habilite servicios en la nube para desencadenar todas las características de OTOBO!',
