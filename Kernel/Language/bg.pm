...
sub Data {
    ...
    $Self->{Translation}       = {
        ...
        'To get the name of the ticket\'s customer user (if given).' =>
            'За да получите името на потребителя на билета ( ID дадено).',
        ...
        'Options of the current user who requested this action' =>
            'Опции на текущия потребител, който е поискал това действие',
        'Options of the ticket data'                           => 'Опции на данните за билетите',
        'Options of ticket dynamic fields internal key values' =>
            'Опциите на динамичните полета на билетите за вътрешните стойности',
        ...
        'Currently support data is only shown in this system.' =>
            'Данните за поддръжка се показват само в тази система.',
        ...
        'These groups are automatically assigned to all customers.' =>
            'Тези групи автоматично се задават на всички клиенти.',
        ...
        'Years in the past to display (default: 5 years).' =>
            'Изминали години за показване (по подразбиране: 5 години).',
        'Years in the future'                                => 'Години напред',
        'Years in the future to display (default: 5 years).' =>
            'Години в бъдеще да се показва (по подразбиране: 5 години).',
        'If special characters (&, @, :, /, etc.) should not be encoded, use \'url\' instead of \'uri\' filter.' =>
            '',
        'Restrict entering of dates'                              => 'Ограничение в въвеждането на дати',
        'Here you can restrict the entering of dates of tickets.' =>
            'Тук можете да ограничите въвеждането на дати за билетите.',

        # Template: AdminDynamicFieldDropdown
        'Add Value'                                                 => 'Добавяне на стойност',
        'Add empty value'                                           => 'Добавете празна стойност',
        'Activate this option to create an empty selectable value.' =>
            'Активирайте тази опция, за да създадете празна избираема стойност.',
        'Tree View'                                         => 'Дървесен вид',
        'Activate this option to display values as a tree.' =>
            'Активирайте тази опция, за да покажете стойностите като дърво.',
        ...
        'Fulltext-search in article (e. g. "Mar*in" or "Baue*").'   =>
            'Търсенето на пълен текст в статия (например "Mar * in" или "Baue *").',
        'To'                                           => 'До',
        'Cc'                                           => 'Копие до',
        'Service'                                      => 'Service',
        ...
        'This invoker will be triggered by the configured events.' =>
            'Този заявки ще бъдат обработени от конфигурираните събития.',
        ...
        'This rule will apply for all keys with no mapping rule.' =>
            'Това правило ще се прилага за всички клавиши без правило за картографиране.',
        'Default rule for unmapped values'                          => 'Правило по подразбиране за оторизирани стойности',
        'This rule will apply for all values with no mapping rule.' =>
            'Това правило ще се прилага за всички стойности без правилото за картографиране.',
        ...
        'The user name to be used to access the remote system.' =>
            'Потребителското име, което ще се използва за достъп до отдалечената система.',
        'BasicAuth Password'                                          => '',
        ...
        'URI of a proxy server to be used (if needed).'               =>
            'URI на прокси сървър, който да се използва (ако е необходимо).',
        'e.g. http://proxy_hostname:8080'                      => 'Например http://proxy_hostname:8080',
        'Proxy User'                                           => 'Прокси потребител',
        'The user name to be used to access the proxy server.' =>
            'Потребителското име, което трябва да се използва за достъп до прокси сървъра.',
        ...
        'Show or hide SSL options to connect to the remote system.' =>
            'Покажете или скрийте опциите за SSL, за да се свържете с отдалечената система.',
        'Client Certificate'                                                                                 => '',
        ...
        'The default HTTP command to use for the requests.' =>
            'По подразбиране HTTP команда, която да се използва за заявките.',
        ...
        'URI to give SOAP methods a context, reducing ambiguities.' =>
            'URI за да даде на SOAP методите контекст, което намалява двусмислеността.',
        ...
        'The character encoding for the SOAP message contents.' =>
            'Кодирането на знаците за съдържанието на SOAP съобщението.',
        ...
        'Select a single configuration version to see its details.' =>
            'Изберете една версия за конфигурация, за да видите нейните подробности.',
        ...
        'Your current web service configuration will be overwritten.' =>
            'Текущата ви конфигурация на уеб услугата ще бъде презаписана.',
        ...
        'Here you will find log information about your system.' =>
            'Тук ще намерите регистрационна информация за вашата система.',
        ...
        'Attributes of the current ticket owner user data' =>
            'Атрибути на данните за текущия потребител на собственика на билета',
        'Attributes of the current ticket responsible user data' =>
            'Атрибути на текущите потребителски данни, отговорни за билетите',
        ...
        'After doing so your OTOBO is up and running.' =>
            'След извършването на това, Вашият OTOBO е напълно работоспособен.',
        ...
        'Address %s replaced with registered customer address.' =>
            'Адресът %s се заменя с регистрирания адрес на клиента.',
        ...
        'Enter the password for the administrative database user.' =>
            'Въведете парола за достъп до администраторската база данни',
        ...
        'Database already contains data - it should be empty!' =>
            'Базата данни вече съдържа данни - тя трябва да е празна.',
        ...
        'The current password is not correct. Please try again!' =>
            'Текущата парола не е правилна. Моля, опитайте отново',
        ...
        'Can\'t update password, it must contain at least 1 digit!' =>
            'Не може да се актуализира паролата, тя трябва да съдържа поне 1 цифра!',
        ...
        'Session limit reached! Please try again later.' =>
            'Вие достигнахте лимита на вашата сесия. Моля опитайте отново по късно.',
        ...
        'Can\'t contact registration server. Please try again later.' =>
            'Не може да се свърже със сървъра за регистрация. Моля, опитайте отново по-късно.',
        'No content received from registration server. Please try again later.' =>
            'Няма получено съдържание от регистрационния сървър. Моля, опитайте отново по-късно.',
        'Can\'t get Token from sever'                           => '',
        'Username and password do not match. Please try again.' =>
            'Потребителското име и парола не се впадат. Моля опитайте по-късно.',
        'Problems processing server result. Please try again later.' =>
            'Проблеми при обработката на резултата от сървъра. Моля, опитайте отново по-късно.',
        ...
        'Sent password reset instructions. Please check your email.' =>
            'Изпратете инструкции за нулиране на паролата. Моля, проверете електронната си поща.',
        'Invalid Token!'                                    => 'Невализно взета стойност!',
        'Sent new password to %s. Please check your email.' =>
            'Изпратете нова парола за %s. Моля, проверете електронната си поща.',
        ...
        'Deleting the field and its data. This may take a while...' =>
            'Изтриване на полето и неговите данни. Това може да отнеме известно време ...',
        ...
        'Do you really want to delete this notification language?' =>
            'Настина ли искате да изтрийте това езиково известие? ',
...
' => '',
        ...
        'All new tickets, these tickets have not been worked on yet' =>
            'Всички нови билети, тези билети все още не са работили по тях.',
