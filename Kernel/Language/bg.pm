...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'It is highly recommended to send this data to OTOBO Team in order to get better support.' =>
            'Препоръчително е да изпратите тези данни на OTOBO група, за да получите по-добра поддръжка.',
        'Configuration' => 'Конфигуриране',
        'Send support data' => 'Изпратете данни за поддръжката',
        'This will allow the system to send additional support data information to OTOBO Team.' =>
            'Това ще позволи на системата да изпрати допълнителна информация за данните за поддръжка на OTOBO Групата.',
        'Update' => 'Обновяване',
        ...
        'Package not verified by the OTOBO Team! It is recommended not to use this package.' =>
            'Пакетът не е проверен от OTOBO група! Препоръчва се да не се използва тази пакет.',
        'Not Started' => '',
        'Updated' => '',
        'Already up-to-date' => '',
        'Installed' => '',
        ...
        'Enable cloud services to unleash all OTOBO features!' => 'Активирайте облачните услуги, за да отключите всички функции на OTOBO.',
