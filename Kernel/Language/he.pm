...
sub Data {
    ...
    $Self->{Completeness}        = 0.241455534772998;
...
הקבצים צריכים להיות בפורמט yml. אשר ייצאו דרך מודול  ACL editor.',
        ...
        'This system is registered with OTOBO Team.' => 'מערכת זו רשומה עם קבוצת OTOBO.',
        ...
        'We will inform you about our new services and offerings soon.' =>
            '',
        'Can I use OTOBO without being registered?' => 'האם אפשר להשתמש ב- OTOBO בלי להירשם',
        ...
        'A registered system sends the following data to OTOBO Team:' => 'רישום מערכת שולח את המידע הבא לקבוצת OTOBO:',
        ...
        'The description and system type you specify help you to identify and manage the details of your registered systems.' =>
            '',
        'How often does my OTOBO system send updates?' => 'כל כמה זמן נשלחים עדכונים למערכת OTOBO?',
        ...
        'After doing so your OTOBO is up and running.' => 'לאחר שמערכת OTOBO תותקן.',
        ...
        # Template: Test
        'OTOBO Test Page' => 'עמוד בדיקה OTOBO',
        'Unlock' => 'שחרר נעילה',
        'Welcome %s %s' => '',
        'Counter' => 'מונה',
        ...
        'OTOBO as provider' => 'OTOBO כמספק',
        'Operations' => '',
        'OTOBO as requester' => 'OTOBO כמבקש',
        'Invokers' => '',
...
' => '',
        ...
        'Your email with ticket number "<OTOBO_TICKET>" is merged to "<OTOBO_MERGE_TO_TICKET>".' =>
            'הדוא"ל שלכם עם פניה מספר "<OTOBO_TICKET>" מוזגה עם פניה "<OTOBO_MERGE_TO_TICKET>".',
