...
sub Data {
    ...
    $Self->{Completeness}        = 0.237063172043011;
...
הקבצים צריכים להיות בפורמט yml. אשר ייצאו דרך מודול  ACL editor.',
        ...
        'This system is registered with OTOBO Team.' => 'מערכת זו רשומה עם קבוצת OTRS.',
        ...
        'A registered system sends the following data to OTOBO Team:' => 'רישום מערכת שולח את המידע הבא לקבוצת OTRS:',
