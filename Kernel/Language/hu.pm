...
sub Data {
    ...
    $Self->{Completeness}        = 0.861882600210179;
    ...
    $Self->{Translation} = {
        ...
        'No map elements found.' => 'Nem találhatók térképelemek.',
        'Up' => 'Fel',
        'Down' => 'Le',
        'Add Mapping Element' => 'Leképezési elemek hozzáadása',
        ...
        'Import summary for %s' => '%s importálási összegzése',
        'Records' => 'Rekordok',
        'Success' => 'Sikeres',
        'Failed' => 'Sikertelen',
