...
sub Data {
    ...
    $Self->{Completeness}        = 0.214669051878354;
    ...
    $Self->{Translation} = {
        ...
        'A new database user with limited permissions will be created for this OTOBO system.' =>
            'Novi uporabnik baze z omejenimi pravicami bo ustvarjen za ta OTOBO sistem',
        'Repeat Password' => '',
        'Generated password' => '',
        ...
        'To be able to use OTOBO you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Da biste mogli koristiti OTOBO morate unijeti slijedeću liniju u Vašu komandnu liniju (Terminal/Shell) kao "root".',
        'Restart your webserver' => 'Ponovno zaženite Vaš WEB Server.',
        'After doing so your OTOBO is up and running.' => 'Po tem bo vaš OTOBO pripravljen na delo.',
        ...
        # Template: Test
        'OTOBO Test Page' => 'OTOBO testna stran',
        'Unlock' => 'Sprosti',
        'Welcome %s %s' => '',
        'Counter' => 'Števec',
        ...
        'The partition where OTOBO is located is almost full.' => 'Razdelek kjer je nameščen OTOBO je skoraj poln.',
...
' => '',
        ...
        'New process ticket' => '',
        'News about OTOBO releases!' => 'Novice o različicah OTOBO!',
        'News about OTOBO.' => '',
        ...
        'Your email with ticket number "<OTOBO_TICKET>" is merged to "<OTOBO_MERGE_TO_TICKET>".' =>
            'Vaše sporočilo E-pošte s številko zahtevka "<OTOBO_TICKET>" je združena z zahtevkom "<OTOBO_MERGE_TO_TICKET>"!',
