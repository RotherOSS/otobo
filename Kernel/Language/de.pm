...
sub Data {
    ...
    $Self->{Completeness}        = 0.995767540289761;
    ...
    $Self->{Translation} = {
        ...
        'An error occured during SysConfig data migration.' => 'Bei der Migration der SysConfig-Daten ist ein Fehler aufgetreten.',
