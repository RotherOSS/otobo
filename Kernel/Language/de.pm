...
sub Data {
    ...
    $Self->{Completeness}        = 0.958075040783034;
...
',
        ...
        'Change Ticket information' => 'Ticket kategorisieren',
        'Change queue!' => 'Queue ändern!',
        ...
        'Defines the communication chanel for the quick close article action.' =>
            'Definiert den Kommunikationskanal für die Schnellschließung von Artikeln.',
        ...
        'Edit contacts with data' => 'Kontaktdaten editieren',
        'Edit contacts with data.' => 'Kontaktdaten editieren.',
        ...
        'OTOBO Team Services' => 'Dienstleistungen des OTOBO Teams',
        ...
        'Sets the default article customer visibility for quick close action in the agent interface.' =>
            'Legt die Standardartikel-Kundentransparenz für schnelle Schließvorgänge in der Agentenoberfläche fest.',
        ...
        'Shows a link in the menu to quick close a ticket in every ticket overview of the agent interface.' =>
            'Zeigt einen Link im Menü an, um ein Ticket in jeder Ticketübersicht der Agentenoberfläche schnell zu schließen.',
        'Shows a link in the menu to quick close a ticket in the ticket zoom view of the agent interface.' =>
            'Zeigt einen Link im Menü an, um ein Ticket in der Ticket-Zoom-Ansicht der Agentenoberfläche schnell zu schließen.',
        ...
        'This configuration defines the number of iterations that should be performed at max for calculating the WorkingTime for a Ticket. Attention: Setting this configuration to high can lead to performance issues.' =>
            'Diese Konfiguration definiert die Anzahl von Iterationen, die durchgeführt werden sollen um die Arbeitszeit eines Tickets zu errechnen. Achtung: Ist diese Konfiguration auf einen zu hohen Wert gesetzt, kann es zu negativen Auswirkungen auf die Performance kommen.',
