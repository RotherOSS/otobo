...
sub Data {
    ...
    $Self->{Completeness}        = 0.95952380952381;
    ...
    $Self->{Translation} = {
        ...
        'Did you know? You can help translating OTOBO at %s.' => 'Haben Sie gewusst, dass Sie unter %s bei der Übersetzung von OTOBO helfen können?',
