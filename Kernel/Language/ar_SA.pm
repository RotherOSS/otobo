...
sub Data {
    ...
    $Self->{Completeness}        = 0.075077022863629;
    ...
    $Self->{Translation} = {
        ...
        # Template: Test
        'OTOBO Test Page' => 'صفحة التجربة ل OTOBO',
        'Unlock'          => 'فك',
        'Welcome %s %s'   => '',
        'Counter'         => 'العداد',
        ...
        'Enter the password for the administrative database user.' =>
            'ادخل كلمة المرور المستخدم المسؤول لقاعدة البيانات.',
        ...
        'Database already contains data - it should be empty!' =>
            'تحتوي قاعدة البيانات على بيانات حالياً - يفترض أن تكون فارغه!',
        ...
        'Can\'t contact registration server. Please try again later.' =>
            'لايمكن الإتصال بخادم التسجيل. الرجاء المحاولة لاحقاً.',
        'No content received from registration server. Please try again later.' =>
            'لم يتم استلام أية محتوى من خادم التسجيل. الرجاء المحاولة لاحقاً.',
        'Can\'t get Token from sever'                           => '',
        'Username and password do not match. Please try again.' =>
            'ليس هناك تطابق بين إسم المستخدم وكلمة المرور. الرجاء المحاولة مرة أخرى.',
        'Problems processing server result. Please try again later.' =>
            'يوجد مشاكل في معالجة نتائج الخادم. الرجاء المحاولة لاحقاً.',
        ...
        'Sent password reset instructions. Please check your email.' =>
            'تم ارسال تعليمات إعادة تعيين كلمة المرور. فضلاً افحص بريدك الإلكتروني.',
        'Invalid Token!'                                    => '',
        'Sent new password to %s. Please check your email.' =>
            'تم إرسال كلمة المرور الجديدة إلى %s. فضلاً افحص بريدك الإلكتروني.',
