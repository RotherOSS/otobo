...
sub Data {
    ...
    $Self->{Translation}       = {
        ...
        'To add a new event select the event object and event name' =>
            '새 이벤트를 추가하려면 이벤트 객체와 이벤트 이름을 선택하십시오.',
        ...
        'Error: Not all keys seem to have values or vice versa.' =>
            '오류 : 모든 키가 값을 가진 것처럼 보이지 않거나 그 반대의 경우도 있습니다.',
        ...
        'Deleting the field and its data. This may take a while...' =>
            '필드 및 해당 데이터 삭제. 이 작업은 다소 시간이 걸릴 수 있습니다...',
...
',
        ...
        'Controls if CustomerID is read-only in the agent interface.' =>
            'CustomerID가 에이전트 인터페이스에서 읽기 전용인지 여부를 제어합니다.',
        ...
        'Default queue ID used by the system in the agent interface.' =>
            '에이전트 인터페이스에서 시스템이 사용하는 기본 대기열 ID입니다.',
        ...
        'Enables or disables the debug mode over frontend interface.' =>
            '프론트 엔드 인터페이스에서 디버그 모드를 활성화 또는 비활성화합니다. ',
        ...
        'Shows a link to see a zoomed email ticket in plain text.' =>
            '확대 / 축소된 전자 메일 티켓을 일반 텍스트로 보려면 링크를 표시합니다.',
