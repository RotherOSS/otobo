...
sub Data {
    ...
    $Self->{Completeness}        = 0.314572351640877;
    ...
    $Self->{Translation} = {
        ...
        'It is highly recommended to send this data to OTOBO Team in order to get better support.' =>
            'Препорачано е да се испратат овие податоци до OTOBO Групацијата за да добиете подобра поддршка.',
        'Configuration' => 'Конфигурација',
        'Send support data' => 'Испрати податоци за поддршка',
        'This will allow the system to send additional support data information to OTOBO Team.' =>
            'Ова ќе овозможи на вашиот систем да праќа дополнителни податоци за поддршка до OTOBO Групацијата.',
        'Update' => 'Ажурирање',
        'System Registration' => 'Регистрација на Систем',
        'To enable data sending, please register your system with OTOBO Team or update your system registration information (make sure to activate the \'send support data\' option.)' =>
            'За да овозможите праќање на податоци, ве молиме регистрирајте го вашиот систем на OTOBO Групацијата или ажурирајте го вешиот систем (не заборавајте да го активирате \'Прати податоци за поддршка\' полето.)',
        ...
        'System registration is a service of OTOBO Team, which provides a lot of advantages!' =>
            'Системската регистрација е сервис на OTOBO Групацијата, која овозможува многу предности!',
        ...
        'Connection to cloud.otrs.com via HTTPS couldn\'t be established. Please make sure that your OTOBO can connect to cloud.otrs.com via port 443.' =>
            'Конекцијата со cloud.otrs.com преку HTTPS неможе да се воспостави. Ве молиме осигурајте се дека вашиот OTOBO може да се поврзе со cloud.otrs.com преку порт 443.',
        ...
        'Go to OTOBO Package Manager' => 'Оди до OTOBO Менаџерот за Пакети',
        ...
        'This system is registered with OTOBO Team.' => 'Системот е регистриран преку OTOBO Групацијата.',
        ...
        'A registered system sends the following data to OTOBO Team:' => 'Регистрираниот систем ги праќа следните податоци до OTOBO Групацијата:',
        ...
        'This data will be frequently transferred to OTOBO Team when you register this system.' =>
            'Овие податоци ќе бидат префрлувани до OTOBO Групацијата кога ќе го регистрирате вашиот систем.',
        'Attribute' => 'Атрибут',
        'FQDN' => 'FQDN',
        ...
        'Continuing with this step will deregister the system from OTOBO Team.' =>
            'Продолжување со овој чекер ке го дерегистрира системот од OTOBO Групацијата.',
        ...
        'This data is sent to OTOBO Team on a regular basis. To stop sending this data please update your system registration.' =>
            'Податоците се испратени до OTOBO Групацијата на регуларна основа. За да прекинете праќање на податоците ве молиме изменете ја вашата регистрација на системот.',
        ...
        'The support bundle will be sent to OTOBO Team via email automatically.' =>
            'Збирот од Податоци за поддршка ќе биде пратен до OTOBO Групацијата автоматски преку е-пошта.',
        'Download File' => 'Превземи Датотека',
        'A file containing the support bundle will be downloaded to the local system. Please save the file and send it to the OTOBO Team, using an alternate method.' =>
            'Датотеката што го содржи збирот од податоците за поддршка ќе биде симнат на вашиот локален систем. Ве молиме зачувајте го податокот и пратете го до OTOBO Групацијата.',
        ...
        'Package not verified by the OTOBO Team! It is recommended not to use this package.' =>
            'Пакетот не е проверен од страна на OTOBO група! Затоа не е препорачливо да го користите овој пакет',
        'Not Started' => '',
        'Updated' => '',
        'Already up-to-date' => '',
        'Installed' => '',
