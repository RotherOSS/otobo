...
sub Data {
    ...
    $Self->{Translation}       = {
        ...
        'Options of ticket dynamic fields internal key values'       =>
            'Опции за вредностите на внатрешни клучните на динамички полиња на тикет.',
        ...
        'Please enter a search term to look for customers.' =>
            'Ве молиме внесете термин за пребарување за пронаоѓање на клиентот.',
        'Customer ID'                         => '',
        ...
        'These groups are automatically assigned to all customers.' =>
            'Овие групи се автоматски доделени на сите потрошувачи.',
        ...
        'Years in the past to display (default: 5 years).' =>
            'Години во минатото да се прикажат (стандардно: 5 години).',
        ...
        'Here you can restrict the entering of dates of tickets.' =>
            'Тука може да го ограничи внесувањето на датумите на билети.',

        # Template: AdminDynamicFieldDropdown
        'Add Value'                                                 => 'Додади Вредност',
        'Add empty value'                                           => 'Додај празна вредност',
        'Activate this option to create an empty selectable value.' =>
            'Активирајте ја оваа опција за да се создаде избор без вредности.',
        'Tree View'                                         => 'Дрво Преглед',
        'Activate this option to display values as a tree.' =>
            'Вклучете ја оваа опција за прикажување на вредности како дрво.',
        ...
        'Do you really want to delete this event trigger?' =>
            'Дали навистина сакате да го избришете овој предизвикувач на настан?',
        ...
        'This invoker will be triggered by the configured events.' =>
            'Овој повикувач ќе биде активиран од конфигурираните настани.',
        ...
        'This rule will apply for all keys with no mapping rule.' =>
            'Оваа правило ќе се однесува за сите типки без мапирачо правило.',
        'Default rule for unmapped values'                          => 'Подразбираме правило за немапирани вредности',
        'This rule will apply for all values with no mapping rule.' =>
            'Оваа правило ќе се однесува за сите вредности без мапирачко правило.',
        ...
        'Do you really want to delete this key mapping?' =>
            'Дали навистина сакате да ги избришете мапирање клучеви?',
        ...
        'Show or hide SSL options to connect to the remote system.'   =>
            'Прикаже или сокри SSL опции за поврзетење на оддалечен систем.',
        'Client Certificate'                                                                                 => '',
        ...
        'URI to give SOAP methods a context, reducing ambiguities.' =>
            'URI за да му даде SOAP контекст методи , намалувајќи нејаснотии.',
        ...
        'Select a single configuration version to see its details.' =>
            'Изберете една конфигурациска верзија за да ги видите неговите детали.',
        ...
        'Your current web service configuration will be overwritten.' =>
            'Вашата моментална веб сервис конфигурација ќе бидат препишани.',
        ...
        'Here you will find log information about your system.' =>
            'Тука можете да најдете запис информации за вашиот систем.',
        ...
        'Just use this feature if you want to log each request.' =>
            'Користија оваа опција само ако сакате да се пријавите на секое барање',
        ...
        'The logfile is too large, you need to reset it' =>
            'Пријавната датотеката е преголема, треба да го ресетирате',
        'Interface'        => 'Интерфејс',
        'Requests'         => 'Побарувања',
        ...
        'Save Activities, Activity Dialogs and Transitions' =>
            'Зачувај Активности, Дијалог на Активности и Транзиции',
        'Do you really want to delete this Process?'  => 'Дали сте сигурни дека сакате да го избришете овој Процес?',
        'Do you really want to delete this Activity?' =>
            'Дали сте сигурни дека сакате да ја избришете оваа Активност?',
        'Do you really want to delete this Activity Dialog?' =>
            'Дали сте сигурни дека сакате да го избришете овој Дијалог на Активности?',
        'Do you really want to delete this Transition?' =>
            'Дали сте сигурни дека сакате да ја избришете оваа Транзиција?',
        'Do you really want to delete this Transition Action?' =>
            'Дали сте сигурни дека сакате да ја избришете оваа Акција на Транзиција?',
        ...
        'Activity dialogs are not being used in this process.' =>
            'Не се искористени дијалози на Активности во овој процес.',
        ...
        'Will be the sender address of this queue for email answers.' =>
            'Ќе биде адреса на испраќачот на оваа редица на е-маил одговори.',
        ...
        'You will receive updates about relevant security releases.' =>
            'Ќе добивате надградби за релевантни безбедносни изданија.',
        ...
        'You can download and use OTOBO without being registered.' =>
            'Можете да го превземете и користите OTOBO без притоа тој да е регистриран.',
        ...
        'There is no data regularly sent from your system to %s.' =>
            'Нема податоци регуларно пратени од вашиот систем до %s.',
        ...
        'Permissions to move tickets into this group/queue.' =>
            'Дозволи за префрлување на тикети во оваа група/редица.',
        'create'                                                   => 'креирај',
        'Permissions to create tickets in this group/queue.'       => 'Дозволи за креирање на тикети во оваа група/редица.',
        'note'                                                     => 'забелешка',
        'Permissions to add notes to tickets in this group/queue.' =>
            'Дозволи за додавање забелешки на тикети во оваа група/редица.',
        'owner'                                                           => 'сопственик',
        ...
        'To show certificate details click on a certificate icon.' =>
            'За прикажување на деталите на сертификат кликнете на иконата од сертификатот.',
        ...
        'Please also update the states in SysConfig where needed.' =>
            'Ве молиме дополнети ја состојбата на SysConfig каде што е потребно.',
        ...
        'Currently this data is only shown in this system.' =>
            'Во моментот само овие податоци се прикажани во овој систем.',
        ...
        'Error: Support data could not be collected (%s).' =>
            'Грешка: Податоците за поддршка не можат да бидат соберени(%s).',
        'Details' => 'Детали',
        ...
        'Create type templates only supports this smart tags' =>
            'Направи нов тип на темплејт кој поддржува паметни тагови',
        ...
        'Don\'t forget to add a new agent to groups and/or roles!' =>
            'Не заборавај да додадеш нов агент во групата или улога!',
        ...
        'Will be auto-generated if left empty.'          =>
            'Ќе бидат генерирани автоматски доколку оставите празно место.',
        'Mobile'                                                                                                                                 => 'Мобилен',
        ...
        'To accept some news, a license or some changes.' =>
            'За да прифатите некои новости, лиценца или некои промени.',
        'Yes, accepted.' => '',
        ...
        'Setting a template will overwrite any text or attachment.' =>
            'Доколку изберете темплејт, текстот и прикачувањата ќе се пребришат.',
        ...
        'Please include at least one customer user for the ticket.' =>
            'Во молиме додавајте барем по еден регистриран корисник за тикетот.',
        ...
        'To protect your privacy, remote content was blocked.' =>
            'За да ја заштитиме вашата приватност,  далечинската содржина е блокирана.',
        ...
        'If set to invalid end users can not generate the stat.' =>
            'Доколку е сетирано во инвалидно, крајни членови нема да генерираат запис.',
        ...
        'Enter the password for the administrative database user.' =>
            'Внесете ја лозинката на корисникот за административната база на податоци.',
        ...
        'Database already contains data - it should be empty!' =>
            'База на податоци веќе содржи податоци-таа треба да биде празна!',
        ...
        'The current password is not correct. Please try again!' =>
            'Тековната лозинка не е точна. Ве молиме обидете се повторно!',
        ...
        'Can\'t update password, it must contain at least 1 digit!' =>
            'Не може да се ажурира лозинка, тоа мора да содржи најмалку 1 цифра!',
        ...
        'Unable to parse repository index document.' =>
            'Неможност за анализрање на складиштето на индекс документот. ',
        ...
        'Can\'t contact registration server. Please try again later.' =>
            'Не може да се  регистрирате на серверот. Ве молиме обидете се повторно подоцна.',
        'No content received from registration server. Please try again later.' =>
            'Нема содржина добиена од серверот за регистрација. Ве молиме обидете се повторно подоцна.',
        'Can\'t get Token from sever'                           => '',
        'Username and password do not match. Please try again.' =>
            'Корисничкото име и лозинката не се совпаѓаат. Ве молиме обидете се повторно.',
        'Problems processing server result. Please try again later.' =>
            'Проблем со обработка на ресурсите за серверот. Ве молиме обидете се повторно подоцна.',
        ...
        'NLS_DATE_FORMAT must be set to \'YYYY-MM-DD HH24:MI:SS\'.' =>
            'NLS_DATE_FORMAT мора да биде поставено на "ГГГГ-ММ-ДД HH24: МИ: СС".',
        ...
        'Not all required Perl modules are correctly installed.' =>
            'Не сите потребни Perl модули се правилно инсталирани.',
        ...
        'There should be no more than 200 MB swap space used.' =>
            'Не треба да има повеќе од 200 MB swap простор што се користи.',
        ...
        'The file system on your OTOBO partition is not writable.' =>
            'На датотечниот систем на вашиот OTOBO партиција не може да се запишува.',
        ...
        'Sent password reset instructions. Please check your email.' =>
            'Испрати лозинка за ресетирање на инструкции. Ве молиме проверете ја вашата е-маил.',
        'Invalid Token!'                                    => 'Невалиден Токен!',
        'Sent new password to %s. Please check your email.' =>
            'Испрати нова лозинка на %s. Ве молиме проверете ја вашата е-пошта.',
        ...
        'Support Data information was successfully sent.' =>
            'Информациите за Податоци за Поддршка се успешно испратени.',
        ...
        'It was not possible to generate the Support Bundle.' =>
            'Не е можно да се генерира Збир од Податоци за поддршка.',
        ...
        'It is going to be deleted from the field, please try again.' =>
            'Ќе биде избришано од полето, ве молиме пробајте повторно.',
        ...
        'Please turn off Compatibility Mode in Internet Explorer!' =>
            'Исклучете го Модот за Компактибилност во Интернет Експлорер!',
        ...
        'There are currently no elements available to select from.' =>
            'Моментално нема елементи достапни за селектирање.',
...
' => '',
        ...
        'All new tickets, these tickets have not been worked on yet' =>
            'Сите нови тикети, на овие тикети уште нема работено',
