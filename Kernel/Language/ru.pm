...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'It is highly recommended to send this data to OTOBO Team in order to get better support.' =>
            'Настоятельно рекомендуется отправлять эти данные в OTOBO Team для получения более точной поддержки.',
        'Configuration' => 'Конфигурация',
        'Send support data' => 'Выслать данные для технической поддержки',
        'This will allow the system to send additional support data information to OTOBO Team.' =>
            'Это позволит системе оправлять дополнительную информацию для поддержки в OTOBO Team.',
        'Update' => 'Обновление',
        'System Registration' => 'Регистрация системы',
        'To enable data sending, please register your system with OTOBO Team or update your system registration information (make sure to activate the \'send support data\' option.)' =>
            'Для включения возможности отсылки данных, зарегистрируйте свою систему в OTOBO Team или обновите ваши регистрационные данные (убедитесь, что активирована функция \'send support data/послать данные для поддержки\'.)',
        ...
        'System registration is a service of OTOBO Team, which provides a lot of advantages!' =>
            'Регистрация системы - это сервис от OTOBO Team, который предоставляет много преимуществ!',
        ...
        'Downgrade to OTOBO' => 'Обновиться до OTOBO',
        ...
        'Your OTOBO is the base for all future actions. Please register first before you continue with the upgrade process of %s!' =>
            'Ваша OTOBO - базовая версия для последующих действий в будущем. Пожалуйста зарегистрируйтесь перед тем, как продолжить процесс обновления %s! ',
        ...
        'Connection to cloud.otrs.com via HTTPS couldn\'t be established. Please make sure that your OTOBO can connect to cloud.otrs.com via port 443.' =>
            'Соединение с cloud.otrs.com по HTTPS не может быть установлено. Убедитесь, что ваша система OTOBO использует порт 443 для соединения с cloud.otrs.com.',
        'Package installation requires patch level update of OTOBO.' => 'Установка пакета требует обновление OTOBO уровня патч.',
        ...
        'Your installed OTOBO version is %s.' => 'Установлена OTOBO версии %s.',
        ...
        'To install this package, the Maximum OTOBO Version is %s.' => 'Для установки пакета необходима версия OTOBO не выше %s.',
        ...
        'You will receive updates for all other relevant OTOBO issues' => 'Вы получите обновления для всех других соответствующих вопросов OTOBO',
        ...
        'Go to OTOBO Package Manager' => 'Перейти к Менеджеру пакетов OTOBO ',
        ...
        'You are about to downgrade to OTOBO and will lose the following features and all data related to these:' =>
            'Вы собираетесь перейти на одну их предыдущих версий OTOBO и потеряете следующие возможности и все данные, связанные с ними:',
        'Chat' => 'Чат',
        ...
        'To be able to use PGP in OTOBO, you have to enable it first.' => 'Чтобы использовать PGP в OTOBO, сначала надо включить его поддержку.',
        ...
        'Package installation requires a patch level update of OTOBO.' => 'Установка пакета требует обновления уровня патчей OTOBO.',
        ...
        'OTOBO Verify™ can not continue!' => 'OTOBO Verify™ не может быть продолжена!',
        ...
        'This system is registered with OTOBO Team.' => 'Эта система зарегистрирована в OTOBO Team.',
        ...
        'A registered system sends the following data to OTOBO Team:' => 'Зарегистрированная система посылает следующие данные в OTOBO Team:',
        ...
        'Your system will send updates to the registration server at regular intervals.' =>
            'Ваша система отправит обновления (отчет) на сервер OTOBO Team периодически.',
        ...
        'This data will be frequently transferred to OTOBO Team when you register this system.' =>
            'Эти данные будут часто передаваться OTOBO Team, когда Вы зарегистрируете эту систему.',
        'Attribute' => 'Атрибут',
        ...
        'Continuing with this step will deregister the system from OTOBO Team.' =>
            'Продолжите этот шаг и вы удалите зарегистрированиую ситему из скписка OTOBO Team.',
        ...
        'Sending support data to OTOBO Team is not possible!' => 'Отправка необходимых данных в OTOBO Team невозможна!',
        'Enable Cloud Services' => 'Включить облачный сервис',
        'This data is sent to OTOBO Team on a regular basis. To stop sending this data please update your system registration.' =>
            'Эти данные отправляются в OTOBO Team на регулярной основе. Чтобы прекратить отправку этих данных, обновите регистрацию вашей системы.',
        ...
        'The support bundle will be sent to OTOBO Team via email automatically.' =>
            'Пакет поддержки будет выслан в OTOBO Team по электронной почте автоматически.',
        'Download File' => 'Загрузить файл.',
        'A file containing the support bundle will be downloaded to the local system. Please save the file and send it to the OTOBO Team, using an alternate method.' =>
            'Файл, содержащий пакет поддержки будет загружен в вашу локальную систему. Сохраните файл и отправьте его в OTOBO Team, используя альтернативный способ.',
        ...
        'There are currently no settings available. Please make sure to run \'otobo.Console.pl Maint::Config::Rebuild\' before using the software.' =>
            'Никакие настройки недоступны. Перед началом работы выполните скрипт  \'otobo.Console.pl Maint::Config::Rebuild\'.',
        ...
        'Really a bug? 5 out of 10 bug reports result from a wrong or incomplete installation of OTOBO.' =>
            'Вы уверены, что это ошибка? В 5 случаях из 10 ошибки возникают из-за некорректной или незавершенной установки OTOBO.',
        ...
        'To be able to use OTOBO you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Чтобы использовать OTOBO, выполните в командной строке под правами root следующую команду:',
        ...
        'Sorry, Apache::Reload is needed as PerlModule and PerlInitHandler in Apache config file. See also scripts/apache2-httpd.include.conf. Alternatively, you can use the command line tool bin/otobo.Console.pl to install packages!' =>
            'Извините! Требуется Apache::Reload для PerlModule и PerlInitHandler в конфигурационном файле Apache. Смотрите также scripts/apache2-httpd.include.conf. Можно, также, использовать утилиту bin/otobo.Console.pl в командной строки для установки пакетов! ',
        ...
        'Package not verified by the OTOBO Team! It is recommended not to use this package.' =>
            'Пакет не верифицирован OTOBO Team! Его использование не рекомендуется.',
        ...
        'Enable cloud services to unleash all OTOBO features!' => 'Включите облачный сервис чтобы получить доступ ко всем возможностям OTOBO! ',
        ...
        'The installation of packages which are not verified by the OTOBO Team is activated. These packages could threaten your whole system! It is recommended not to use unverified packages.' =>
            'Активирована установка пакетов, которые не верифицированы OTOBO Team. Эти пакеты могут влиять на работу вашей системе! Не рекомендуется использовать непроверенные пакеты.',
        ...
        '<p>If you continue to install this package, the following issues may occur:</p><ul><li>Security problems</li><li>Stability problems</li><li>Performance problems</li></ul><p>Please note that issues that are caused by working with this package are not covered by OTOBO service contracts.</p>' =>
            '<p>Если вы продолжите установку этого пакета, могут возникнуть следующие проблемы:</p><ul><li>Проблемы безопасности</li><li>Стабильности</li><li>Производительности</li></ul><p>Помните, что возникшие при работе с таким пакетом проблемы не решаются в рамках сервисного контракта OTOBO!</p>',
        ...
        'The partition where OTOBO is located is almost full.' => 'Раздел, в котором размещен OTOBO уже заполнен.',
        'The partition where OTOBO is located has no disk space problems.' =>
            'Раздел с OTOBO не имеет проблем с дисковым пространством.',
        ...
        'Some packages are not verified by the OTOBO Team! It is recommended not to use this packages.' =>
            'Некоторые пакеты не верифицированы OTOBO Team! Их использование не рекомендуется.',
        ...
        'System was not able to calculate user Date in OTOBOTimeZone!' => 'Системе не удалось вычислить дату пользователя в OTOBOTimeZone!',
...
',
        ...
        'Configure sending of support data to OTOBO Team for improved support.' =>
            'Настройте отправку необходимых данных для поддержки в OTOBO Team для расширенной поддержки.',
        ...
        'Configures a default TicketDynamicField setting. "Name" defines the dynamic field which should be used, "Value" is the data that will be set, and "Event" defines the trigger event. Please check the developer manual (https://doc.otobo.org/doc/), chapter "Ticket Event Module".' =>
            'Задает настройки TicketDynamicField по умолчанию. "Name/Имя" задает поле, которое будет использоваться, "Value/Значение" - данные которые будут заданы и "Event/Событие" определяет событие триггера. Подробнее, смотрите в руководстве разработчика (https://doc.otobo.org/doc/), раздел "Ticket Event Module".',
        ...
        'Defines the default front-end (HTML) theme to be used by the agents and customers. If you like, you can add your own theme. Please refer the administrator manual located at https://doc.otobo.org/doc/.' =>
            'Задает имя темы (HTML theme - имя папки для альтернативных модулей), которая будет использоваться в интерфейсах агентов и клиентов. По желанию, вы можете добавить свою собственную тему. Подробности в руководстве администратора https://doc.otobo.org/doc/.',
        ...
        'Malay' => 'Малайский',
        'Manage OTOBO Team cloud services.' => 'Управление облачными сервисами OTOBO Team.',
        ...
        'Manage system registration.' => 'Регистрация системы на портале OTOBO Team',
