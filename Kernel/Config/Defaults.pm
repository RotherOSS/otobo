...
#    $Self->{'OTOBOTimeZone'} = 'UTC';
    ...
    # --------------------------------------------------- #
    # WebMaxFileSize
    # (Max size for browser file uploads per file - default ~ 48 MB)
    $Self->{WebMaxFileSize} = 48000000;

    # WebMaxUploadSize
    # (Max size for browser file uploads combined - default ~ 48 MB)
    $Self->{WebMaxUploadSize} = 48000000;
